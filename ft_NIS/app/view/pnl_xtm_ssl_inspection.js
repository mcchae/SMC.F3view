...
Ext.define('SMC.view.pnl_xtm_ssl_inspection', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_ssl_inspection',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_ssl_inspectionAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_ssl_inspectionBeforeClose,
                    scope: me
                }
            }
        });
