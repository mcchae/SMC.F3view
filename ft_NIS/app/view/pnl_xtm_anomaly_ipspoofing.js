...
Ext.define('SMC.view.pnl_xtm_anomaly_ipspoofing', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_anomaly_ipspoofing',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_anomaly_ipspoofingAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_anomaly_ipspoofingBeforeClose,
                    scope: me
                }
            }
        });
    ...
    onTxf_addrFocus1: function(component, e, eOpts) {
        // onTxf_addrFocus1 ==============================================================================================================================================================
        //
        // 일시 : 2014.09.30
        //
