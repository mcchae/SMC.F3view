...
Ext.define('SMC.view.pnl_xtm_dns_dynamic', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_dns_dynamic',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_dns_dynamicAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_dns_dynamicBeforeClose,
                    scope: me
                }
            }
        });
