...
Ext.define('SMC.view.pnl_xtm_mgt_report', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_mgt_report',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                ...
                },
                {
                    ...
                    items: [
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                change: {
                                                    fn: me.onRdg_report_selecttimeChange,
                                                    scope: me
                                                }
                                            }
                                        },
                        ...
                        },
                        {
                            ...
                            listeners: {
                                itemclick: {
                                    fn: me.onGpn_report_listItemClick,
                                    scope: me
                                }
                            },
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_mgt_reportAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_mgt_reportBeforeClose,
                    scope: me
                }
            }
        });
    ...
    onBt_trackerClick: function(button, e, eOpts) {
        ...
        var selectRecord = trackerGrid.getSelectionModel().getSelection()[0];

        if(selectRecord){

            Ext.create('widget.xtm_mgt_tracker', {

                'selectRecord' : selectRecord,
                'reportsList'  : trackerGrid,
                'parentObject' : this
    ...
    onPnl_xtm_mgt_reportAfterRender: function(component, eOpts) {
        ...
        var reportStore = Ext.getStore('st_report_reportlist');
        var createDayStore = Ext.getStore('st_report_createday');
