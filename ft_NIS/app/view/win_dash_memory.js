...
Ext.define('SMC.view.win_dash_memory', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onWin_dash_memoryAfterRender,
                    scope: me
                },
                destroy: {
                    fn: me.onWin_dash_memoryDestroy,
                    scope: me
                }
            }
        });
    ...
    onWin_dash_memoryAfterRender: function(component, eOpts) {
        ...
        Ext.Ajax.request(
            {
                ...
                success : function(res_data)
                {
                    ...
                    Ext.getStore('st_dash_memory').loadData(resObj);
                }
            });

    },

    onWin_dash_memoryDestroy: function(component, eOpts) {
        Ext.TaskManager.start(Ext.getCmp('pnl_dash_main').task);


        var store = Ext.getStore('st_dash_memory');
        store.sync();
