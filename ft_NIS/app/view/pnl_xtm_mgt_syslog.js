...
Ext.define('SMC.view.pnl_xtm_mgt_syslog', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_mgt_syslog',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                afterrender: {
                                    fn: me.onCtn_sendlog_controlAfterRender,
                                    scope: me
                                }
                            }
                        },
                        {
                            ...
                            listeners: {
                                itemclick: {
                                    fn: me.onGpn_log_standardItemClick,
                                    scope: me
                                }
                            },
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_mgt_syslogAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_mgt_syslogBeforeClose,
                    scope: me
                }
            }
        });
