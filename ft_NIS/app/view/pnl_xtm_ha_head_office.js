    ...
    onPnl_xtm_ha_head_officeAfterRender: function(component, eOpts) {
        ...
        // 브릿지 데이터 초기화 ===========================================================================================================================================================
            ...
            if(deviceData.bridge){
                ...
                if(deviceData.bridge.checker_link){

                    bridgeStore.add(deviceData.bridge.checker_link);

                }

                var internalEth = deviceData.bridge.packet_relay.internal['interface'];
                ...
                var externalEth = deviceData.bridge.packet_relay.external['interface'];
