...
Ext.define('SMC.view.pnl_xtm_dns_outer', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_dns_outer',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            itemId: 'ctn_dnsouter_control',
                                            margin: '0, 0, 10, 0',
                                            padding: 10,
                                            listeners: {
                                                afterrender: {
                                                    fn: me.onCtn_dnsouter_controlAfterRender,
                                                    scope: me
                                                }
                                            }
                                        },
                                        {
                                            ...
                                            listeners: {
                                                itemclick: {
                                                    fn: me.onGpn_dnsouter_enablenetworkItemClick,
                                                    scope: me
                                                }
                                            },
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_dns_outerAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_dns_outerBeforeClose,
                    scope: me
                }
            }
        });
    ...
    onCtn_dnsouter_controlAfterRender: function(component, eOpts) {
    ...
    initStore: function() {
        ...
        Ext.getStore('st_dns_outdomain').removeAll();
        Ext.getStore('st_dns_outenablenet').removeAll();
    }
