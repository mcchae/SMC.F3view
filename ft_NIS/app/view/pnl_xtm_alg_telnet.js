...
Ext.define('SMC.view.pnl_xtm_alg_telnet', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_alg_telnet',
        ...
        Ext.applyIf(me, {
            items: [
                ...
                },
                {
                    ...
                    listeners: {
                        afterrender: {
                            fn: me.onCtn_algtelnet_controlAfterRender,
                            scope: me
                        }
                    }
                },
                {
                    ...
                    listeners: {
                        itemclick: {
                            fn: me.onGpn_telnet_setItemClick,
                            scope: me
                        }
                    },
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_alg_telnetAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_alg_telnetBeforeClose,
                    scope: me
                }
            }
        });
    ...
    initStore: function() {
        // initStore =====================================================================================================================================================================
        //
        // 설명 : Telnet 에 설정된 데이터를 초기화 합니다.
        //
        // ===============================================================================================================================================================================

        Ext.getStore('st_alg_telnet').removeAll();
    }
