...
Ext.define('SMC.view.pnl_smc_device_view', {
                                        ...
                                        if(centerContainer.oldView){
                                            ...
                                            function(res){
                                                ...
                                                if(westObj._dynamicGrid){
                                                    ...
                                                    westObj._dynamicGrid.getStore().loadData(res);
                                            ...
                                            function(res){
                                                ...
                                                function(_grid_tpl){
                                                        ...
                                                        'selModel'	: Ext.create('Ext.selection.CheckboxModel', {
                                                            ...
                                                            listeners: {
                                                                select: function(records){
                                                                    ...
                                                                    controlToolbar.down('[itemId=bt_policy]').setDisabled(false);
                                                                ...
                                                                deselect: function(records){
                                                                    ...
                                                                    if(!deviceList.getSelectionModel().getSelection().length){
                                                                        ...
                                                                        controlToolbar.down('[itemId=bt_policy]').setDisabled(true);
                                                    ...
                                                    westObj._dynamicGrid.on('itemclick', function(obj, record, item, index, e, eOpts){
                                                    ...
                                                    searchDeviceName(westObj._dynamicGrid.getStore(), centerPanel.down('[itemId=tb_smc_device_search]').down('[itemId=txf_searchstr]').getValue(), ['name', 'ip']);
                    ...
                    setSMCContextObj: function() {
                        ...
                        },
                        {
                            ...
                            'callback' : function(){
                                ...
                                var selectCid = gridObj.getSelectionModel().getSelection()[0].raw['@cid'];
                        ...
                        },
                        {
                            ...
                            'callback' : function(){
                                ...
                                deviceCUD.deleteDevice(deviceList, cidArray, groupCid, function(){
                                    ...
                                    centerPanel.down('[itemId=tb_smc_device_control]').down('[itemId=bt_policy]').setDisabled(true);
                                ...
                                Ext.Msg.show({
                                    ...
                                    fn : function(res){
                                        ...
                                        if(res === 'yes'){
                                            ...
                                            var deviceCid = Ext.getCmp(DEVICE_COMMON_ID.devicelist).getSelectionModel().getSelection()[0].raw['@cid'];

                                            devFuncModule.devCopy(deviceCid, groupCid);
    ...
    */
    ...
    onRdg_smc_selelctmodeChange: function(field, newValue, oldValue, eOpts) {
        ...
        var westTreePanel    = Ext.getCmp('pnl_smc_device_view_west');

        // 모드 변경시 장비 리스트 갱신 타이머 종료 ==========================================================================================================================================

        if(centerPanel.taskObj){

            console.log('장비 타이머를 종료합니다 ...');

            clearInterval(centerPanel.taskObj);

            console.log('Timer Object -> ', centerPanel.taskObj);
            ...
            if(centerPanel.down('[itemId=tb_smc_device_search]').down('[itemId=rdg_smc_selelctmode]').getValue().mode === 'device'){
                ...
                if(Ext.getCmp(RTM_COMMON_ID.devicelist)){
                    ...
                    if(store){
                        ...
                        searchDeviceName(store, textfield.getValue(), ['name', 'gate_ip']);
    ...
    onBt_policyClick: function(button, e, eOpts) {
        ...
        // 일시 : 2014.06.30
        //
        // 설명 : 장비의 정책 전송 기능을 가진 버튼의 핸들러를 설정합니다.
        //
        // 수정 : (김민수 2014.07.22 - 모니터 탭 삭제로 인한 이벤트 추가)
        //
        // ==============================================================================================================================================================================
