...
Ext.define('SSL.view.win_ssl_ipv6group', {
    ...
    onButtonClick1: function(button, e, eOpts) {
        var component = Ext.getCmp('win_ssl_ipv6group');
        ...
        var header = 'kr.co.future.frodo.xtmconf.msgbus.ObjectPlugin.addIpv6Group';
        var body = {'num':0, 'name':name, 'desc' : desc, 'member': member};

        if (component.isNew === false)
        {
            var raw = Ext.getCmp('win_ssl_address').getComponent('tabControl').getComponent('ipv6_group').getComponent('grid').getSelectionModel().getSelection()[0].raw;
            header = 'kr.co.future.frodo.xtmconf.msgbus.ObjectPlugin.modifyIpv6Group';
    ...
    onWindowAfterRender: function(component, eOpts) {
        if(component.isNew === false)
        {
            var item = Ext.getCmp('win_ssl_address').getComponent('tabControl').getComponent('ipv6_group').getComponent('grid').getSelectionModel().getSelection()[0].raw;
            ...
            store.loadData(Ext.getStore('st_ssl_ipv6').data.items);
