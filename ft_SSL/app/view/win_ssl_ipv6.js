...
Ext.define('SSL.view.win_ssl_ipv6', {
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            flex: 1,
                                            cls: 'lb_info',
                                            text: 'IP 객체 입력형태 ex) Single:1::1 Range:1::1-1::2 Prefix:1::1/32'
                                        }
                                    ]
                                },
                                {
    ...
    onButtonClick1: function(button, e, eOpts) {
        var component = Ext.getCmp('win_ssl_ipv6');
        ...
        var header = 'kr.co.future.frodo.xtmconf.msgbus.ObjectPlugin.addIpv6Address';

        if (component.isNew === false)
        {
            var raw = Ext.getCmp('win_ssl_address').getComponent('tabControl').getComponent('ipv6').getComponent('grid').getSelectionModel().getSelection()[0].raw;
            body.cid = raw.cid;
            body.num = raw.num;
            var header = 'kr.co.future.frodo.xtmconf.msgbus.ObjectPlugin.modifyIpv6Address';
        }
    ...
    onWindowAfterRender: function(component, eOpts) {
        if(component.isNew === false)
        {
            var item = Ext.getCmp('win_ssl_address').getComponent('tabControl').getComponent('ipv6').getComponent('grid').getSelectionModel().getSelection()[0].raw;
