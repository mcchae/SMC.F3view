...
Ext.define('SMC4ZEN.view.pnl_policy_rule_adv', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_policy_rule_adv',

    requires: [
        'SMC4ZEN.view.pnl_policy_rule_advViewModel',
            ...
            items: [
                {
                    ...
                    valueField: 'appCid',
                    listeners: {
                        change: 'onCb_policy_rule_adv_appChange'
                    }
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    valueField: 'schCid',
                    listeners: {
                        change: 'onCb_policy_rule_adv_schChange'
                    }
                },
                {
                    xtype: 'toolbar',
            ...
            items: [
                {
                    ...
                    valueField: 'qosCid',
                    listeners: {
                        change: 'onCb_policy_rule_adv_qosChange'
                    }
                },
                {
                    xtype: 'toolbar',
            ...
            items: [
                {
                    ...
                    boxLabel: 'IPS',
                    listeners: {
                        change: 'onChk_policy_rule_adv_IPSChange'
                    }
                },
                {
                    xtype: 'combobox',
                    ...
                    valueField: 'ipsVal',
                    listeners: {
                        change: 'onCb_policy_rule_adv_IPS_typeChange'
                    }
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    labelSeparator: ' ',
                    listeners: {
                        change: 'onChk_policy_rule_adv_expireChange'
                    }
                },
                {
                    xtype: 'datefield',
                    ...
                    format: 'Y/m/d',
                    listeners: {
                        change: 'onDt_policy_rule_adv_expire_dateChange'
                    }
                },
                {
                    xtype: 'label',
                ...
                },
                {
                    ...
                    valueField: 'hour',
                    listeners: {
                        change: 'onCb_policy_rule_adv_expire_hourChange'
                    }
                },
                {
                    xtype: 'label',
                ...
                },
                {
                    ...
                    listeners: {
                        change: 'onChk_policy_rule_adv_expire_nowChange'
                    }
                }
            ]
        }
