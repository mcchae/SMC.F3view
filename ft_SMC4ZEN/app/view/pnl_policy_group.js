...
Ext.define('SMC4ZEN.view.pnl_policy_group', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_policy_group2',

    requires: [
        'SMC4ZEN.view.pnl_policy_groupViewModel',
        'Ext.tree.Panel',
        'Ext.toolbar.Toolbar',
        'Ext.button.Button',
        'Ext.tree.View',
                ...
                items: [
                    {
                        ...
                        listeners: {
                            render: 'onTree_policy_groupRender',
                            afterrender: 'onTree_policy_groupAfterRender',
                            itemclick: 'onTree_policy_groupItemClick',
                            select: 'onTree_policy_groupSelect'
                        }
                    },
                    {
                        xtype: 'panel',
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    itemdblclick: 'onGpnl_policy_listItemDblClick',
                        ...
                        listeners: {
                            beforedestroy: 'onPnl_policy_listBeforeDestroy'
                        }
                    }
                ]
            };
    ...
    onButtonClick: function(button, e, eOpts) {
        ...
        if(typeof _sModel === 'undefined'){
            ...
            var dlg = Ext.create('SMC4ZEN.view.win_policy_add_group', {
                _policy_grp : this,
    ...
    onButtonClick1: function(button, e, eOpts) {
        ...
        if(typeof _sModel === 'undefined'){
            ...
            var dlg = Ext.create('SMC4ZEN.view.win_policy_modify_group', {
                _policy_grp : this,
    ...
    onButtonClick2: function(button, e, eOpts) {
        ...
        if(typeof _sModel === 'undefined'){
            ...
            var dlg = Ext.create('SMC4ZEN.view.win_policy_del_group', {
                _policy_grp : this,
                _cid : _sModel.raw.cid,
                _grp_name : _sModel.raw.text
            });
    ...
    onTree_policy_groupAfterRender: function(component, eOpts) {
        ...
        makeContextMenu({'itemId' : 'mn_policy_context', 'width' : 180, 'border' : false}, component, contextCallback, policy_Context_Array);
    },
    ...
    onButtonClick3: function(button, e, eOpts) {
        ...
        if(typeof _sModel === 'undefined'){
            ...
            var dlg = Ext.create('SMC4ZEN.view.win_policy_spd_add',{
                kind : _gtype,
                _policy_grp : this,
    ...
    onButtonClick4: function(button, e, eOpts) {
        ...
        if(_sModel.parentNode.raw){
            _kind = _sModel.parentNode.raw.gtype;
        }
        else{
        ...
        if(_gModel && _sModel){
            var dlg = Ext.create('SMC4ZEN.view.win_policy_spd_modify',{
                ...
                _policy_name : _gModel.data.name
            });
            dlg.show();
        } else {
            if(!_gModel){
            ...
            search_tree(
                ...
                function(_target_array){
                    ...
                    me.fn_list_init(_target_array[0].raw.cid, function(){
                        ...
                        var  _row = _store.findRecord('@cid', record.data['@cid']);
    ...
    onPanelBoxReady: function(component, width, height, eOpts) {
        ...
        me.down('gridpanel[itemId=gpnl_policy_list]').bindStore(Ext.create('SMC4ZEN.store.st_policy_list'));
