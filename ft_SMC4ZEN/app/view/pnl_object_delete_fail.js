...
Ext.define('SMC4ZEN.view.pnl_object_delete_fail', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_delete_fail',

    requires: [
        'SMC4ZEN.view.pnl_object_delete_failViewModel',
        'Ext.form.Label',
        'Ext.grid.Panel',
                            ...
                            items: [
                                {
                                    ...
                                    listeners: {
                                        select: 'onGpn_object_gridSelect'
                                    }
                                }
                            ]
                        },
