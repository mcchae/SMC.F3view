...
Ext.define('SMC4ZEN.view.pnl_xtm_route_vrrp', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_route_vrrpViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_route_vrrpAfterRender',
        beforeclose: 'onPnl_xtm_route_vrrpBeforeClose'
    },
            ...
            config = {
                items: [
                    ...
                    },
                    {
                        ...
                        margin: '0, 0, 10, 0',
                        listeners: {
                            afterrender: 'onCtn_vrrp_controlAfterRender'
                        }
                    },
                    {
                        xtype: 'container',
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    itemclick: 'onGpn_vrrp_gridItemClick'
                                },
    ...
    initStore: function() {
        var st_vrrp = Ext.getStore('st_route_vrrp');

        st_vrrp.removeAll();

        this.down('[itemId=ctn_vrrp_grid]').down('[itemId=gpn_vrrp_grid]').bindStore(st_vrrp);
    }
