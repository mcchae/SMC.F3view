...
Ext.define('SMC4ZEN.view.pnl_xtm_network_dhcp_server', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_network_dhcp_serverViewModel',
    ...
    viewModel: {
        type: 'pnl_xtm_network_dhcp_server'
    },
    height: 680,
    ...
    listeners: {
        afterrender: 'onPnl_xtm_network_dhcp_serverAfterRender',
        beforeclose: 'onPnl_xtm_network_dhcp_serverBeforeClose'
    },
            ...
            config = {
                items: [
                    ...
                    },
                    {
                        ...
                        margin: '0, 0, 10, 0',
                        listeners: {
                            afterrender: 'onCtn_dhcpserver_controlAfterRender'
                        }
                    },
                    {
                        xtype: 'gridpanel',
                        ...
                        listeners: {
                            itemclick: 'onGpn_dhcpserver_setItemClick'
                        },
    ...
    initStore: function() {
        var st_dhcpserver = Ext.getStore('st_dhcpserver_set');

        st_dhcpserver.removeAll();

        this.down('[itemId=gpn_dhcpserver_set]').bindStore(st_dhcpserver);
    }
