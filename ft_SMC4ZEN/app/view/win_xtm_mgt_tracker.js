...
Ext.define('SMC4ZEN.view.win_xtm_mgt_tracker', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_xtm_mgt_trackerViewModel',
        'Ext.form.FieldSet',
    ...
    listeners: {
        afterrender: 'onWin_xtm_mgt_trackerAfterRender'
    },
            ...
            config = {
                items: [
                                ...
                                items: [
                                    {
                                        ...
                                        listeners: {
                                            ...
                                            beforerender: 'onCmb_typeBeforeRender'
                                        }
                                    },
                                    {
                                        xtype: 'combobox',
                            ...
                            },
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        valueField: 'value',
                                        listeners: {
                                            afterrender: 'onCmb_guardAfterRender'
                                        }
                                    },
                                    {
                                        xtype: 'combobox',
                                        ...
                                        valueField: 'value',
                                        listeners: {
                                            afterrender: 'onCmb_workAfterRender'
                                        }
                                    }
                                ]
                            }
                    ...
                    },
                    {
                        ...
                        listeners: {
                            itemclick: 'onGpn_tracker_listItemClick',
                            render: 'onGpn_tracker_listRender'
                        },
    ...
    onCmb_typeBeforeRender: function(component, eOpts) {
    ...
    onCmb_guardAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
    ...
    onCmb_workAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
    ...
    onBt_saveClick: function(button, e, eOpts) {
        ...
        var gpn_reportlist = this.parentObject.down('[itemId=ctn_report_atoz]').down('[itemId=gpn_report_list]');
        var selectRecord = gpn_reportlist.getSelection()[0];

        // 트래커 레코드를 생성합니다.

        if(trackerStore.count() <= 0){

            if(selectRecord.get('tracker')){

                selectRecord.set('tracker', []);
            ...
            selectRecord.set('tracker', tmpArray);

        }

        console.log('Tracker key -> ', selectRecord);
    ...
    onWin_xtm_mgt_trackerAfterRender: function(component, eOpts) {
        var component = this.componentStorage();
        var st_trackerlist = Ext.getStore('st_tracker_list');
        var gpn_reportlist = this.parentObject.down('[itemId=ctn_report_atoz]').down('[itemId=gpn_report_list]');
        ...
        var st_trackeract = Ext.getStore('st_tracker_act');
        var st_trackersort = Ext.getStore('st_tracker_sort');
        var st_trackertype = Ext.getStore('st_tracker_search');

        // 1. 컴포넌트 바인딩

        component.trackerbasic.bindStore(st_trackertype);
        component.trackersort.bindStore(st_trackersort);
        component.trackeract.bindStore(st_trackeract);
        ...
        try{
            ...
            if(selectRecord.get('tracker') && selectRecord.get('tracker').length > 0){

                Ext.each(selectRecord.get('tracker'), function(trackerData){

                    st_trackerlist.add(trackerData);
