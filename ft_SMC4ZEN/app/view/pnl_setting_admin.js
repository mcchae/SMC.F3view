...
Ext.define('SMC4ZEN.view.pnl_setting_admin', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_setting_admin',

    requires: [
        'SMC4ZEN.view.pnl_setting_adminViewModel',
        'Ext.toolbar.Toolbar',
        'Ext.button.Button',
        'Ext.grid.Panel',
    ...
    listeners: {
        show: 'onPnl_setting_adminShow',
        afterrender: 'onPnl_setting_adminAfterRender'
    },
    ...
    onButtonClick: function(button, e, eOpts) {
        Ext.create('SMC4ZEN.view.pnl_setting_admin_set').show();
    },
    ...
    onButtonClick2: function(button, e, eOpts) {
        ...
        if(record)
        {
            var win = Ext.create('SMC4ZEN.view.pnl_setting_admin_set',{
                edit : "edit"
            });
    ...
    onPnl_setting_adminAfterRender: function(component, eOpts) {
        Ext.getCmp('grid_users').bindStore(Ext.create('SMC4ZEN.store.st_UserList'));
    },
