...
Ext.define('SMC4ZEN.view.pnl_object_isakmp_sa', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_isakmp_sa',

    requires: [
        'SMC4ZEN.view.pnl_object_isakmp_saViewModel',
        'Ext.tab.Panel',
        'Ext.tab.Tab',
        'Ext.form.RadioGroup',
                            ...
                            items: [
                                {
                                    ...
                                    listeners: {
                                        itemdblclick: 'onTrpn_ipSecItemDblClick'
                                    }
                                },
                                {
                                    xtype: 'container',
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                itemdblclick: 'onGpn_ipsec_gridItemDblClick'
                                            }
                                        },
                                        {
                                            xtype: 'container',
                                                    ...
                                                    items: [
                                                        {
                                                            ...
                                                            checked: true,
                                                            listeners: {
                                                                change: 'onRd_xauth_clientChange'
                                                            }
                                                        },
                                                        {
                                                            xtype: 'radiofield',
    ...
    listeners: {
        afterrender: 'onPnl_object_isakmp_saAfterRender',
        beforedestroy: 'onPnl_object_isakmp_saBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('combobox[itemId="cmb_certificate"]').bindStore(Ext.create('SMC4ZEN.store.st_ISAKMP_Certificate'));
        me.down('combobox[itemId="cmb_mode"]').bindStore(Ext.create('SMC4ZEN.store.st_ISAKMP_Mode'));
        me.down('combobox[itemId="cmb_encryption"]').bindStore(Ext.create('SMC4ZEN.store.st_ISAKMP_Encryption'));
        me.down('combobox[itemId="cmb_auth"]').bindStore(Ext.create('SMC4ZEN.store.st_ISAKMP_Auth'));
        me.down('combobox[itemId="cmb_group"]').bindStore(Ext.create('SMC4ZEN.store.st_IPSec_KeyGroup'));
        me.down('combobox[itemId="cmb_time"]').bindStore(Ext.create('SMC4ZEN.store.st_ISAKMP_Time'));
        me.down('gridpanel[itemId="gpn_ipsec_grid"]').bindStore(Ext.create('SMC4ZEN.store.st_ISAKMP_IPSec'));
        me.down('gridpanel[itemId="gpn_host_grid"]').bindStore(Ext.create('SMC4ZEN.store.st_IPSec_Host'));
        me.down('combobox[itemId="cmb_id_change"]').bindStore(Ext.create('SMC4ZEN.store.st_ISAKMP_IDType'));

        me.down('combobox[itemId="cmb_certificate"]').select(Ext.getStore('st_ISAKMP_Certificate').getAt(0));
