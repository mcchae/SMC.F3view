...
Ext.define('SMC4ZEN.view.pnl_xtm_multi_policy', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_multi_policyViewModel',
        'Ext.form.FieldSet',
        'Ext.form.field.Text',
        'Ext.button.Button'
    ],
    ...
    listeners: {
        afterrender: 'onPnl_xtm_multipolicyAfterRender',
        beforeclose: 'onPnl_xtm_multipolicy_settingBeforeClose'
    },
