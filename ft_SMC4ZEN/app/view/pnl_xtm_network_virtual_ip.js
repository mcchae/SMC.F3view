...
Ext.define('SMC4ZEN.view.pnl_xtm_network_virtual_ip', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_network_virtual_ipViewModel',
    ...
    viewModel: {
        type: 'pnl_xtm_network_virtual_ip'
    },
    height: 680,
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    margin: '0, 0, 10, 0',
                    listeners: {
                        afterrender: 'onCtn_virtualv4_controlAfterRender'
                    }
                },
                {
                    xtype: 'gridpanel',
                    ...
                    listeners: {
                        render: 'onGpn_virtual_ipv4Render',
                        itemclick: 'onGpn_virtual_ipv4ItemClick'
                    }
                }
            ]
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    margin: '0, 0, 10, 0',
                    listeners: {
                        afterrender: 'onCtn_virtualv6_controlAfterRender'
                    }
                },
                {
                    xtype: 'gridpanel',
                    ...
                    listeners: {
                        render: 'onGpn_virtual_ipv6gridRender',
                        itemclick: 'onGpn_virtual_ipv6ItemClick'
                    }
                }
            ]
        }
    ...
    listeners: {
        afterrender: 'onPnl_xtm_network_virtual_ipAfterRender',
        beforeclose: 'onPnl_xtm_network_virtual_ipBeforeClose'
    },
