...
Ext.define('SMC4ZEN.view.pnl_xtm_multi_basic', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_multi_basicViewModel',
        'Ext.form.FieldSet',
        'Ext.form.Panel',
            ...
            items: [
                {
                    ...
                    valueField: 'area',
                    listeners: {
                        afterrender: 'onCmb_areaAfterRender1'
                    }
                }
            ]
        },
    ...
    listeners: {
        afterrender: 'onPnl_xtm_multi_basicAfterRender',
        beforeclose: 'onPnl_xtm_multi_basicBeforeClose'
    },

    onCmb_groupinfoAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            'storeId' : 'st_multi_corp',
            'fields' : [
                {	'name' : 'name'		},
                {	'name' : 'value'	}
            ],
