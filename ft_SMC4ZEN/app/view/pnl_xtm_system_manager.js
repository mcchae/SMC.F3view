...
Ext.define('SMC4ZEN.view.pnl_xtm_system_manager', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_system_managerViewModel',
        'SMC4ZEN.view.ctn_system_control',
        'Ext.tab.Panel',
        'Ext.tab.Tab',
        'Ext.form.Panel',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'ctn_system_control',
                            itemId: 'ctn_manager_control',
                            margin: '0, 0, 10, 0',
                            listeners: {
                                afterrender: 'onCtn_manager_controlAfterRender'
                            }
                        },
                        {
                            xtype: 'gridpanel',
                            ...
                            listeners: {
                                itemclick: 'onGpn_manager_usergridItemClick'
                            }
                        }
                    ]
                },
    ...
    listeners: {
        afterrender: 'onPnl_xtm_system_managerAfterRender',
        beforeclose: 'onPnl_xtm_system_managerBeforeClose'
    },
    ...
    onCtn_manager_controlAfterRender: function(component, eOpts) {
        ...
        bt_del.on('click', function(){
            ...
            console.log('DATA -> ', me.validityCheck().managerAuthorityLowCtn());
    ...
    initStore: function() {
        ...
        component.managerGrid.bindStore(gridStore);
        component.portGrid.bindStore(portStore);
    }
