...
Ext.define('SMC4ZEN.view.pnl_object_waf', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_waf',

    requires: [
        'SMC4ZEN.view.pnl_object_wafViewModel',
        'Ext.form.FieldSet',
    ...
    listeners: {
        afterrender: 'onPnl_object_wafAfterRender',
        beforedestroy: 'onPnl_object_wafBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('gridpanel[itemId="gpn_port"]').bindStore(Ext.create('SMC4ZEN.store.st_Waf_Port'));
