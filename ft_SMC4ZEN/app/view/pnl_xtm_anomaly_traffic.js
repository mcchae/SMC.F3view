...
Ext.define('SMC4ZEN.view.pnl_xtm_anomaly_traffic', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_anomaly_trafficViewModel',
        'Ext.form.FieldSet',
                    ...
                    items: [
                        {
                            ...
                            valueField: 'value',
                            listeners: {
                                change: 'onCmb_actionChange1',
                                afterrender: 'onCmb_actionAfterRender1'
                            }
                        },
                        {
                            xtype: 'numberfield',
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    valueField: 'value',
                                    listeners: {
                                        afterrender: 'onCmb_sensitiveAfterRender2'
                                    }
                                }
                            ]
                        }
    ...
    listeners: {
        afterrender: 'onPnl_xtm_anomaly_trafficAfterRender',
        beforeclose: 'onPnl_xtm_anomaly_trafficBeforeClose'
    },
    ...
    onCmb_actionAfterRender1: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            'storeId' : 'st_anomaly_action',
            'fields' : [
                {	'name' : 'name'	},
    ...
    onCmb_sensitiveAfterRender2: function(component, eOpts) {
