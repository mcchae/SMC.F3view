...
Ext.define('SMC4ZEN.view.pnl_xtm_network_bonding', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_network_bondingViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_network_bondingAfterRender',
        beforeclose: 'onPnl_xtm_network_bondingBeforeClose'
    },
            ...
            config = {
                items: [
                                ...
                                items: [
                                    {
                                        ...
                                        valueField: 'name',
                                        listeners: {
                                            afterrender: 'onCmb_bondingnameAfterRender'
                                        }
                                    },
                                    {
                                        xtype: 'combobox',
                                    ...
                                    },
                                    {
                                        ...
                                        valueField: 'value',
                                        listeners: {
                                            afterrender: 'onCmb_lacprateAfterRender'
                                        }
                                    },
                                    {
                                        xtype: 'numberfield',
                    ...
                    },
                    {
                        ...
                        margin: '10, 0, 10, 0',
                        listeners: {
                            afterrender: 'onCtn_bonding_controlAfterRender'
                        }
                    },
                    {
                        xtype: 'gridpanel',
                        ...
                        listeners: {
                            itemclick: 'onGpn_bonding_setItemClick'
                        }
                    }
                ]
            };
    ...
    onCmb_bondingnameAfterRender: function(component, eOpts) {
    ...
    onCmb_runmodeAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            ...
            'data' : [
                {	'name' : 'Round Robin'	,  'mode' : 0  },
                {	'name' : 'Active Backup',  'mode' : 1  },
                {	'name' : 'Balance XOR'	,  'mode' : 2  },
                {	'name' : 'Broadcast'	,  'mode' : 3  },
                {	'name' : '802.3ad'		,  'mode' : 4  },
                {	'name' : 'Balance TLB'	,  'mode' : 5  },
                {	'name' : 'Balance ALB'	,  'mode' : 6  }
            ]
        }));
    ...
    onCmb_lacprateAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
    ...
    initStore: function() {
        ...
        // 2. 스토어 바인딩 (스토어를 공유하는 그리드만 해당)

        component.member.bindStore(memberStore);
        component.arpipmember.bindStore(arpStore);
        component.bondgrid.bindStore(bondStore);
    }
