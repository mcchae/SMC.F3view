...
Ext.define('SMC4ZEN.view.win_object_ipsec_compile', {
    extend: 'Ext.window.Window',
    alias: 'widget.object_ipsec_compile',

    requires: [
        'SMC4ZEN.view.win_object_ipsec_compileViewModel',
        'Ext.form.FieldSet',
    ...
    listeners: {
        afterrender: 'onWin_object_ipsec_compileAfterRender'
    },
