...
Ext.define('SMC4ZEN.view.pnl_object_ipv6_addr', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_ipv6_addr',

    requires: [
        'SMC4ZEN.view.pnl_object_ipv6_addrViewModel',
        'Ext.form.field.Text',
        'Ext.form.FieldSet',
        'Ext.grid.Panel',
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                itemclick: 'onGpn_ipAddressItemClick'
                            }
                        },
                        {
                            xtype: 'container',
                            ...
                            items: [
                                {
                                    ...
                                    msgTarget: 'none',
                                    listeners: {
                                        keydown: 'onTxf_ipAddressKeydown',
                                        change: 'onTxf_ipAddressChange'
                                    }
                                },
                                {
                                    xtype: 'container',
    ...
    listeners: {
        afterrender: 'onPnl_object_ipv6_addrAfterRender',
        beforedestroy: 'onPnl_object_ipv6_addrBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('gridpanel[itemId="gpn_ipAddress"]').bindStore(Ext.create('SMC4ZEN.store.st_ObjectIpGrid'));
