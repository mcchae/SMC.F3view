...
Ext.define('SMC4ZEN.view.pnl_object_ssl_server_group', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_ssl_server_group',

    requires: [
        'SMC4ZEN.view.pnl_object_ssl_server_groupViewModel',
        'Ext.form.field.Text',
        'Ext.form.FieldSet',
        'Ext.tree.Panel',
        'Ext.tree.View',
    ...
    viewModel: {
        type: 'pnl_object_ssl_server_group'
    },
    border: false,
    height: 550,
                    ...
                    items: [
                        {
                            ...
                            useArrows: true,
                            listeners: {
                                itemdblclick: 'onTpn_serverGroupItemDblClick'
                            }
                        },
                        {
                            xtype: 'container',
                            ...
                            items: [
                                {
                                    ...
                                    listeners: {
                                        itemdblclick: 'onGpn_serverGroupItemDblClick'
                                    }
                                },
                                {
                                    xtype: 'container',
    ...
    listeners: {
        afterrender: 'onPnl_object_ssl_server_groupAfterRender',
        beforedestroy: 'onPnl_object_ssl_server_groupBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('gridpanel[itemId="gpn_serverGroup"]').bindStore(Ext.create('SMC4ZEN.store.st_SSLServerGroup'));
