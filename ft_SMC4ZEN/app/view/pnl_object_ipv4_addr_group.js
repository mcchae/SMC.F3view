...
Ext.define('SMC4ZEN.view.pnl_object_ipv4_addr_group', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_ipv4_addr_group',

    requires: [
        'SMC4ZEN.view.pnl_object_ipv4_addr_groupViewModel',
        'Ext.form.field.Text',
        'Ext.tree.Panel',
        'Ext.tree.View',
    ...
    viewModel: {
        type: 'pnl_object_ipv4_addr_group'
    },
    border: false,
    height: 550,
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            handler: function(button, e) {
                                                ...
                                                var _kind = ['obj_ip_v4_addr', 'obj_ip_v4_group'];
    ...
    listeners: {
        afterrender: 'onPnl_object_ipv4_addr_groupAfterRender',
        beforedestroy: 'onPnl_object_ipv4_addr_groupBeforeDestroy'
    },
