...
Ext.define('SMC4ZEN.view.pnl_object_hierarchy', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_hierarchy',

    requires: [
        'SMC4ZEN.view.pnl_object_hierarchyViewModel',
        'Ext.tab.Panel',
        'Ext.tab.Tab',
        'Ext.tree.Panel',
        'Ext.tree.View',
    ...
    listeners: {
        afterrender: 'onPnl_object_hierarchyAfterRender'
    },
                        ...
                        items: [
                            {
                                ...
                                handler: function(button, e) {
                                    ...
                                    if(selected_data)
                                    {
                                        ...
                                        {
                                            var object_name_window = Ext.create('SMC4ZEN.view.pnl_object_name_mod');
    ...
    loadData: function(data, data_parent, data_children) {
        ...
        me.down('gridpanel[itemId="gpn_object_grid"]').bindStore(Ext.create('SMC4ZEN.store.st_ObjectLink_Object'));
        me.down('gridpanel[itemId="gpn_device_grid"]').bindStore(Ext.create('SMC4ZEN.store.st_ObjectLink_Gate'));
        me.down('gridpanel[itemId="gpn_policy_grid"]').bindStore(Ext.create('SMC4ZEN.store.st_ObjectLink_Policy'));
