...
Ext.define('SMC4ZEN.view.pnl_object_sec_host', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_sec_host',

    requires: [
        'SMC4ZEN.view.pnl_object_sec_hostViewModel',
        'Ext.form.field.Text',
        'Ext.form.FieldSet',
        'Ext.grid.Panel',
    ...
    listeners: {
        afterrender: 'onPnl_object_sec_hostAfterRender',
        beforedestroy: 'onPnl_object_sec_hostBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('gridpanel[itemId="gpn_ipAddress"]').bindStore(Ext.create('SMC4ZEN.store.st_IPSec_Host'));
