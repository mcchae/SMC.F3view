...
Ext.define('SMC4ZEN.view.win_xtm_sendpolicy', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_xtm_sendpolicyViewModel',
    ...
    listeners: {
        render: 'onWin_xtm_sendpolicyRender',
    ...
    reloadDeviceList: function(selectCids) {
        ...
        request_helper.xmlrpc_call_Ajax_Post(
            ...
            function(res){
                ...
                policyGrid.selectRecords = policyGrid.getSelection();
                ...
                component.policy_progress.updateProgress((progressValue <= 0.05) ? 0.05 : progressValue, (progressValue <= 0.05) ? '5 %' : (progressValue * 100).toString());
                ...
                if(res.summary.total === (res.summary.success + res.summary.failed)){
                    ...
                    component.policy_progress.updateProgress(1, '100 %');
