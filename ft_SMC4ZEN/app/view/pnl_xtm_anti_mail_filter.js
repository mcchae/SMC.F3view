...
Ext.define('SMC4ZEN.view.pnl_xtm_anti_mail_filter', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_anti_mail_filterViewModel',
        'Ext.form.FieldSet',
            ...
            items: [
                {
                    ...
                    valueField: 'value',
                    listeners: {
                        afterrender: 'onCmb_deleteAfterRender'
                    }
                },
                {
                    xtype: 'container',
                    ...
                    items: [
                        {
                            ...
                            valueField: 'value',
                            listeners: {
                                change: 'onCmb_maxlimitChange',
                                afterrender: 'onCmb_maxlimitAfterRender'
                            }
                        },
                        {
                            xtype: 'numberfield',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_anti_mail_filterAfterRender',
        beforeclose: 'onPnl_xtm_anti_mail_filterBeforeClose'
    },

    onCmb_deleteAfterRender: function(component, eOpts) {
    ...
    onCmb_maxlimitAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            'storeId' : 'st_mail_maxlimit',
            'fields' : [
                {	'name' : 'name'		},
                {	'name' : 'value'}
            ],
            'data' : [
                {	'name' : '제한하지 않음', 'value' : false	},
                {	'name' : '제한함', 'value' : true	}
            ]
        }));
