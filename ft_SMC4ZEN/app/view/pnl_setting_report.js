...
Ext.define('SMC4ZEN.view.pnl_setting_report', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_setting_report',

    requires: [
        'SMC4ZEN.view.pnl_setting_reportViewModel',
        'Ext.toolbar.Toolbar',
        'Ext.form.Label',
        'Ext.form.field.Date',
        'Ext.form.field.Time',
    ...
    listeners: {
        afterrender: 'onPnl_setting_reportAfterRender'
    },
                                ...
                                items: [
                                    {
                                        ...
                                        listeners: {
                                            change: 'onCmb_audit_periodChange1'
                                        }
                                    },
                                    {
                                        xtype: 'label',
    ...
    onPnl_setting_reportAfterRender: function(component, eOpts) {
        ...
        component.down('gridpanel[itemId="gpn_setting_audit_report"]').bindStore(Ext.create('SMC4ZEN.store.st_SettingAuditReport'));
