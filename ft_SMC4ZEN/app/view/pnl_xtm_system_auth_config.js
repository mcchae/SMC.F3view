...
Ext.define('SMC4ZEN.view.pnl_xtm_system_auth_config', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_system_auth_configViewModel',
        'Ext.form.FieldSet',
        'Ext.form.Panel',
    ...
    viewModel: {
        type: 'pnl_xtm_system_auth_config'
    },
    height: 680,
    ...
    listeners: {
        afterrender: 'onPnl_xtm_system_auth_configAfterRender',
        beforeclose: 'onPnl_xtm_system_auth_configBeforeClose'
    },
        ...
        var validCheckObj = {
            ...
            radiusBlankCheck : function(){
                ...
                if(component.fds_radius.checkboxCmp.getValue()){
                    ...
                    if(component.backup_ip.getValue() === ''){
                    ...
                    if(component.backup_passwd.getValue() === ''){
                    ...
                    if(component.backup_auth.getValue() === null){
                    ...
                    if(component.backup_account.getValue() === null){
                    ...
                    if(component.backup_statchk.getValue() === null){
            ...
            radiusValidCheck : function(){
                ...
                if(component.fds_radius.checkboxCmp.getValue()){
                    ...
                    if(!component.backup_ip.validate()){
                    ...
                    if(!component.backup_auth.validate()){
                    ...
                    if(!component.backup_account.validate()){
                    ...
                    if(!component.backup_statchk.validate()){
