...
Ext.define('SMC4ZEN.view.pnl_xtm_multi_log', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_multi_logViewModel',
        'Ext.form.FieldSet',
                    ...
                    items: [
                        {
                            ...
                            boxLabel: '로그 압축 사용',
                            listeners: {
                                change: 'onCk_usecompressChange1'
                            }
                        },
                        {
                            xtype: 'label',
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    listeners: {
                        itemclick: 'onGpn_logset_ipItemClick1'
                    }
                }
            ]
        }
    ...
    initStore: function() {
        var component = this.componentStorage();
        var st_logip = Ext.getStore('st_multiset_logip');

        st_logip.removeAll();

        component.workgpn_grid.bindStore(st_logip);
    }
