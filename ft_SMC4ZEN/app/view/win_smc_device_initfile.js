...
Ext.define('SMC4ZEN.view.win_smc_device_initfile', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_smc_device_initfileViewModel',
        'Ext.form.Label',
    ...
    listeners: {
        destroy: 'onWin_xtm_initfile_passwordDestroy'
    },
    ...
    exportFile: function() {
        ...
        // 수정 :
        //
        // - (2014.. 김민수 : 버튼 이벤트에서 this 이벤트로 변경됨. 엔터키 입력시 기능을 공유하기 위함.)
        //
        // - (2015.02.02 김민수 : 비밀번호 / 비밀번호 확인시 match 메서드 제거, 문자열 비교로 변경)
        //
        // ==============================================================================================================================================================================
