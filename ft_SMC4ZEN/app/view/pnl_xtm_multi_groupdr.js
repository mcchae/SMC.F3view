...
Ext.define('SMC4ZEN.view.pnl_xtm_multi_groupdr', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_multi_groupdrViewModel',
        'Ext.form.FieldSet',
        'Ext.button.Button',
        'Ext.grid.Panel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_multi_groupdrAfterRender',
        beforeclose: 'onPnl_xtm_multi_groupdrBeforeClose'
    },
