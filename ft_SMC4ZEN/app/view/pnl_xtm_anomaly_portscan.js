...
Ext.define('SMC4ZEN.view.pnl_xtm_anomaly_portscan', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_anomaly_portscanViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_anomaly_portscanAfterRender',
        beforeclose: 'onPnl_xtm_anomaly_portscanBeforeClose'
    },
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    afterrender: 'onCmb_sensitiveAfterRender'
                                }
                            }
                        ]
                    },
                                ...
                                columns: [
                                    ...
                                    },
                                    {
                                        ...
                                        editor: {
                                            ...
                                            valueField: 'value',
                                            listeners: {
                                                afterrender: 'onCmb_actionAfterRender'
                                            }
                                        }
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        editor: {
                                            ...
                                            valueField: 'value',
                                            listeners: {
                                                afterrender: 'onCmb_blocktypeAfterRender'
                                            }
                                        }
                                    },
                                    {
    ...
    onCmb_sensitiveAfterRender: function(component, eOpts) {
        component.setValue('Any');
    },

    onCmb_actionAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
        ...
        component.setValue('alert');
    },

    onCmb_blocktypeAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            'storeId' : 'st_anomaly_blocktype',
            'fields' : [
                {	'name' : 'name'		},
                {	'name' : 'value'	}
            ],
            'data' : [
                {	'name' : '① Protocol, 출발지 IP, Port 차단 (1 : N)', 'value' : 1		},
                {	'name' : '② Protocol, 목적지 IP, Port 차단 (N : 1)', 'value' : 2		}
            ]
        }));
    ...
    componentStorage: function() {
        ...
        obj.watchPortscan = this.down('[itemId=fds_portscan_watchip]').down('[itemId=gpn_portscan_watch]');
        ...
        obj.sourcePortscan = this.down('[itemId=fds_portscan_sourceip]').down('[itemId=gpn_portscan_destination]');
        ...
        obj.destinationPortscan = this.down('[itemId=fds_portscan_destinationip]').down('[itemId=gpn_portscan_destination]');
    ...
    initStore: function() {
        var component = this.componentStorage();
        var extentStore = Ext.getStore('st_portscan_extention');
        var watchipStore = Ext.getStore('st_portscan_watchip');
        var sourceipStore = Ext.getStore('st_portscan_sourceip');
        var destinationipStore = Ext.getStore('st_portscan_destinationip');
        ...
        component.extentionList.bindStore(extentStore);
        component.watchPortscan.bindStore(watchipStore);
        component.sourcePortscan.bindStore(sourceipStore);
        component.destinationPortscan.bindStore(destinationipStore);
    }
