...
Ext.define('SMC4ZEN.view.pnl_object_name_mod', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_name_mod',

    requires: [
        'SMC4ZEN.view.pnl_object_name_modViewModel',
