...
Ext.define('SMC4ZEN.view.pnl_xtm_multi_basic_access', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_multi_basic_accessViewModel',
        'Ext.form.FieldSet',
        'Ext.form.field.ComboBox'
    ],

    viewModel: {
        type: 'pnl_xtm_multi_basic_access'
    },
    height: 680,
    ...
    listeners: {
        afterrender: 'onPnl_xtm_multi_basic_accessAfterRender',
        beforeclose: 'onPnl_xtm_multi_basic_accessBeforeClose'
    },
