...
Ext.define('SMC4ZEN.view.pnl_xtm_ssl_vpn', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_xtm_ssl_vpn',

    requires: [
        'SMC4ZEN.view.pnl_xtm_ssl_vpnViewModel',
        'Ext.form.FieldSet',
        'Ext.form.RadioGroup',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_ssl_vpnAfterRender',
        beforeclose: 'onPnl_xtm_ssl_vpnBeforeClose'
    },
    ...
    initStore: function() {
        var st_ssllist = Ext.getStore('st_ssl_usrgroups');

        st_ssllist.removeAll();

        this.down('[itemId=fds_ssl_usergroup]').down('[itemId=gpn_ssl_usrgroup]').bindStore(st_ssllist);
    }
