...
Ext.define('SMC4ZEN.view.pnl_xtm_vpn_host', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_vpn_hostViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_vpn_hostAfterRender',
        beforeclose: 'onPnl_xtm_vpn_hostBeforeClose'
    },
            ...
            config = {
                items: [
                                ...
                                items: [
                                    {
                                        ...
                                        listeners: {
                                            render: 'onGpn_vpnhost_objectlistRender'
                                        },
                                        features: [
                                            {
                                                ftype: 'summary',
                    ...
                    },
                    {
                        ...
                        margin: '0, 0, 10, 0',
                        listeners: {
                            afterrender: 'onCtn_vpnhost_controlAfterRender'
                        }
                    },
                    {
                        xtype: 'gridpanel',
                        ...
                        listeners: {
                            render: 'onGpn_vpnhost_hostlistRender',
                            itemclick: 'onGpn_vpnhost_hostlistItemClick'
                        },
    ...
    onBt_addClick: function(button, e, eOpts) {
        ...
        Ext.create('SMC4ZEN.view.win_smc_object_set', {
            ...
            'gtype'         : 'obj_ip',
            'thisObj'       : this,
            'componentObj' : component.gpn_objectlist
