...
Ext.define('SMC4ZEN.view.pnl_object_user', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_user',

    requires: [
        'SMC4ZEN.view.pnl_object_userViewModel',
        'Ext.form.FieldSet',
                            ...
                            items: [
                                {
                                    xtype: 'textfield',
                                    validator: function(value) {
                                        var me = this.up('window[itemId="pnl_object_user"]');
                                    ...
                                    items: [
                                        {
                                            ...
                                            handler: function(button, e) {
                                                Ext.create('SMC4ZEN.view.pnl_object_select').loadData('obj_ssl_svr_group');
                                            },
                                            margin: 1,
                                            width: 100,
                                            text: '선택'
    ...
    listeners: {
        afterrender: 'onPnl_object_userAfterRender',
        beforedestroy: 'onPnl_object_userBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('combobox[itemId="cmb_authtype"]').bindStore(Ext.create('SMC4ZEN.store.st_User_AuthType'));
        me.down('combobox[itemId="cmb_mode"]').bindStore(Ext.create('SMC4ZEN.store.st_User_Mode'));
