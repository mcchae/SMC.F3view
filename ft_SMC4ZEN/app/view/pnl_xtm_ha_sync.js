...
Ext.define('SMC4ZEN.view.pnl_xtm_ha_sync', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_ha_syncViewModel',
        'Ext.form.FieldSet',
        'Ext.form.Panel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_ha_syncAfterRender',
        beforeclose: 'onPnl_xtm_ha_syncBeforeClose'
    },
    ...
    onPnl_xtm_ha_syncAfterRender: function(component, eOpts) {
        ...
        componentObj.useline.checkboxCmp.on('change', function(cb, newValue, oldValue, eOpts){
            ...
            if(newValue){
                ...
                if(!componentObj.usesync.checkboxCmp.getValue()){

                    Ext.Msg.show({
                        title : SMC_SET_PRODUCT,
                        msg : '세션 동기화 사용에 체크를 해주세요.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
