...
Ext.define('SMC4ZEN.view.win_xtm_routetable', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_xtm_routetableViewModel',
    ...
    listeners: {
        afterrender: 'onWin_xtm_routetableAfterRender',
        destroy: 'onWin_xtm_routetableDestroy'
    },
    ...
    onCmb_selectAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            ...
            'data' : [
                {	'name' : 'All Routing Tables	', 'value' : 'all'		},
                {	'name' : 'Static				', 'value' : 'static'	},
                {	'name' : 'RIP					', 'value' : 'rip'		},
                {	'name' : 'OSPF					', 'value' : 'ospf'		},
                {	'name' : 'BGP					', 'value' : 'bgp'		}
            ]
        }));
