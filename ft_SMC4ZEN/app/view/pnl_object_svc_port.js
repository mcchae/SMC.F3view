...
Ext.define('SMC4ZEN.view.pnl_object_svc_port', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_svc_port',

    requires: [
        'SMC4ZEN.view.pnl_object_svc_portViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_object_svc_portAfterRender',
        beforedestroy: 'onPnl_object_svc_portBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('combobox[itemId="cmb_protocol"]').bindStore(Ext.create('SMC4ZEN.store.st_ProtocolType'));
