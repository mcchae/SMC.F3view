...
Ext.define('SMC4ZEN.view.pnl_xtm_anti_virus', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_anti_virusViewModel',
        'Ext.form.FieldSet',
        'Ext.form.RadioGroup',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_anti_virusAfterRender',
        beforeclose: 'onPnl_xtm_anti_virusBeforeClose'
    },
