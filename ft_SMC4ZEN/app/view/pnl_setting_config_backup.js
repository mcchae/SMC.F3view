...
Ext.define('SMC4ZEN.view.pnl_setting_config_backup', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_setting_config_backup',

    requires: [
        'SMC4ZEN.view.pnl_setting_config_backupViewModel',
        'Ext.form.FieldSet',
    ...
    viewModel: {
        type: 'pnl_setting_config_backup'
    },
    ...
    listeners: {
        show: 'onPnl_setting_config_backupShow',
        afterrender: 'onPnl_setting_config_backupAfterRender'
    },
                                                        ...
                                                        success: function(fp, o) {
                                                            ...
                                                            function(response){
                                                                ...
                                                                if(response)
                                                                {
                                                                    ...
                                                                    {
                                                                        var migration_window = Ext.create('SMC4ZEN.view.pnl_migration_result');
    ...
    onPnl_setting_config_backupAfterRender: function(component, eOpts) {
        component.down('combobox[itemId="cmb_period"]').bindStore(Ext.create('SMC4ZEN.store.st_BackupPeriod'));
        component.down('combobox[itemId="cmb_weekly"]').bindStore(Ext.create('SMC4ZEN.store.st_BackupWeekday'));
        component.down('gridpanel[itemId="gpn_backup_list"]').bindStore(Ext.create('SMC4ZEN.store.st_BackupList'));
    },

    loadData: function() {
        var me = this;

        me.down('combobox[itemId="cmb_period"]').select(me.down('combobox[itemId="cmb_period"]').getStore().getAt(0));
        me.down('combobox[itemId="cmb_weekly"]').select(me.down('combobox[itemId="cmb_weekly"]').getStore().getAt(0));
