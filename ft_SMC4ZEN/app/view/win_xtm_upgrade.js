...
Ext.define('SMC4ZEN.view.win_xtm_upgrade', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_xtm_upgradeViewModel',
        'Ext.form.FieldSet',
        'Ext.form.Panel',
    ...
    listeners: {
        afterrender: 'onWin_xtm_upgradeAfterRender',
        destroy: 'onWin_xtm_upgradeDestroy'
    },
                        ...
                        items: [
                            {
                                ...
                                items: [
                                        ...
                                        items: [
                                            {
                                                ...
                                                valueField: 'value',
                                                listeners: {
                                                    change: 'onCmb_selectviewChange',
                                                    afterrender: 'onCmb_selectviewAfterRender'
                                                }
                                            },
                                            {
                                                xtype: 'container',
                                    ...
                                    },
                                    {
                                                ...
                                                items: [
                                                    {
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            ...
                                                            var deleteList = [];
                                                            var st_selectfile = Ext.getStore('st_upgrade_selectfile');

                                                            deleteList.push(record.get('_id'));
                                                            ...
                                                            st_selectfile.removeAt(rowIndex);
                                                        },
                                        ...
                                        listeners: {
                                            render: 'onGpn_upgrade_fileRender'
                                        }
                                    }
                                ]
                            },
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        listeners: {
                                            render: 'onGpn_upgrade_devRender'
                                        }
                                    }
                                ]
                            }
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    render: 'onGpn_upgrade_devstateRender'
                                }
                            },
                            {
                                xtype: 'progressbar',
    ...
    onCmb_selectviewChange: function(field, newValue, oldValue, eOpts) {
        var store = Ext.getStore('st_upgrade_category');
    ...
    onCmb_selectviewAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            'storeId' : 'st_upgrade_category',
            'fields' : [
                {	'name' : 'name'		},
                {	'name' : 'value'	}
            ],
            'data' : [
                ...
                {	'name' : 'RamDisk  ', 'value' : 'ramdisk'	},
                {	'name' : 'AppImg   ', 'value' : 'appimg'	},
                {	'name' : 'DO       ', 'value' : 'do'		},
                {	'name' : 'KISCOM DB    ', 'value' : 'kiscomdb'	},
                {	'name' : 'Virus Pattern', 'value' : 'virus'		},
    ...
    onBt_upgradeClick: function(button, e, eOpts) {
        ...
        var selectFile = component.grid_file.getSelection();
        var selectDev = component.grid_dev.getSelection();
        ...
        for(var i = 0; i < selectFile.length; i++){
            ...
            fileObj.file_name = selectFile[i].get('file_name');
            fileObj.file_type = selectFile[i].get('file_type');
        ...
        for(var i = 0; i < selectDev.length; i++){
            ...
            cid_list.push(selectDev[i].get('cid'));
            ...
            function(res){
                ...
                request_helper.xmlrpc_call_Ajax_Post(
                    ...
                    function(res){
                        ...
                        component.grid_upgrade.selectRecords = component.grid_upgrade.getSelection();
                ...
                if(res === 'yes'){
                    ...
                    var allCid = function(){
                        ...
                        for(var i = 0, max = st_upgrade.count(); i < max; i++){
                            ...
                            allcid.push(st_upgrade.data.items[i].get('@cid'));
    ...
    onGpn_upgrade_devstateRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
    ...
    onWin_xtm_upgradeAfterRender: function(component, eOpts) {
        ...
        Ext.each(component.selectRecord, function(selectDev){
            ...
            devObj.name = selectDev.get('name');
            devObj.cid  = selectDev.get('@cid');
            devObj.ip   = selectDev.get('ip');
            devObj.spd_state = selectDev.get('spd_state');
            devObj.percent = 0;
        ...
        request_helper.xmlrpc_call_Ajax_Get(
            ...
            function(res){
                ...
                if(!arguments[1]){
                    ...
                    component.pgb_process.updateProgress((progressValue <= 0.05) ? 0.05 : progressValue, (progressValue <= 0.05) ? '5 %' : (progressValue * 100).toString());

                }
                else{

                    component.pgb_process.updateProgress(0, '0%');
                ...
                upgradeGrid.selectRecords = upgradeGrid.getSelection();
