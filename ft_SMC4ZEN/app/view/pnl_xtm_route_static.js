...
Ext.define('SMC4ZEN.view.pnl_xtm_route_static', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_route_staticViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_route_staticAfterRender',
        beforeclose: 'onPnl_xtm_route_staticBeforeClose'
    },
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                margin: '0, 0, 10, 0',
                                listeners: {
                                    afterrender: 'onCtn_static_controlAfterRender'
                                }
                            },
                            {
                                xtype: 'container',
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        listeners: {
                                                            itemclick: 'onGrid_ipv4ItemClick1'
                                                        },
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        columns: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                flex: 1,
                                                                listeners: {
                                                                    checkchange: 'onCheckcolumnCheckChange1'
                                                                }
                                                            }
                                                        ],
                                                        listeners: {
                                                            itemclick: 'onGrid_ipv4ItemClick2'
                                                        },
                                                        selModel: Ext.create('Ext.selection.RowModel', {
                                                            selType: 'rowmodel',
                                                            mode: 'MULTI'
    ...
    initStore: function() {
        ...
        component.grid_ipv4.bindStore(ipv4Store);
        component.grid_ipv6.bindStore(ipv6Store);
    }
