...
Ext.define('SMC4ZEN.view.pnl_object_schedule', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_schedule',

    requires: [
        'SMC4ZEN.view.pnl_object_scheduleViewModel',
        'Ext.form.FieldSet',
        'Ext.grid.Panel',
        'Ext.view.Table',
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                itemclick: 'onGpn_schedule_periodItemClick'
                            }
                        },
                        {
                            xtype: 'container',
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                itemclick: 'onGpn_schedule_timeItemClick'
                            }
                        },
                        {
                            xtype: 'container',
                    ...
                    items: [
                        {
                            ...
                            handler: function(button, e) {
                                ...
                                Ext.create('SMC4ZEN.view.pnl_object_schedule_setting').loadData(me.object.month, me.object.day);
                            },
                            margin: 1,
                            width: 100,
                            text: '특정 월/일 설정'
    ...
    listeners: {
        beforedestroy: 'onPnl_object_scheduleBeforeDestroy'
    },

    onGpn_schedule_periodItemClick: function(dataview, record, item, index, e, eOpts) {
        this.down('datefield[itemId="dtf_period_start"]').setValue(record.data.start);
        this.down('datefield[itemId="dtf_period_end"]').setValue(record.data.end);
    },

    onGpn_schedule_timeItemClick: function(dataview, record, item, index, e, eOpts) {
        this.down('timefield[itemId="tmf_time_start"]').setValue(record.data.start);
        this.down('timefield[itemId="tmf_time_end"]').setValue(record.data.end);
    },
    ...
    loadData: function(record) {
        ...
        me.down('gridpanel[itemId="gpn_schedule_period"]').bindStore(Ext.create('SMC4ZEN.store.st_SchedulePeriod'));
        me.down('gridpanel[itemId="gpn_schedule_time"]').bindStore(Ext.create('SMC4ZEN.store.st_ScheduleTime'));
