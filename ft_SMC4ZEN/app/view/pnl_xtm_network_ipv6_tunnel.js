...
Ext.define('SMC4ZEN.view.pnl_xtm_network_ipv6_tunnel', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_network_ipv6_tunnelViewModel',
    ...
    viewModel: {
        type: 'pnl_xtm_network_ipv6_tunnel'
    },
    height: 680,
    ...
    listeners: {
        afterrender: 'onPnl_xtm_network_ipv6_tunnelAfterRender',
        beforeclose: 'onPnl_xtm_network_ipv6_tunnelBeforeClose'
    },
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        valueField: 'value',
                                        listeners: {
                                            change: 'onCmb_ttlChange',
                                            afterrender: 'onCmb_ttlAfterRender'
                                        }
                                    }
                                ]
                            },
                            ...
                            },
                            {
                                ...
                                margin: '0, 0, 10, 0',
                                listeners: {
                                    afterrender: 'onCtn_tunnel_controlAfterRender'
                                }
                            },
                            {
                                xtype: 'gridpanel',
                                ...
                                listeners: {
                                    itemclick: 'onGpn_tunnel_listItemClick'
                                },
    ...
    onCmb_ttlAfterRender: function(component, eOpts) {
    ...
    initStore: function() {
        var component = this.componentStorage();
        var st_tunnel = Ext.getStore('st_tunnel_set');

        st_tunnel.removeAll();

        component.tunnel_grid.bindStore(st_tunnel);
    }
