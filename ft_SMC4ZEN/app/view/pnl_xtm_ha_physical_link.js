...
Ext.define('SMC4ZEN.view.pnl_xtm_ha_physical_link', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_ha_physical_linkViewModel',
        'Ext.form.FieldSet',
        'Ext.grid.Panel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_ha_physical_linkAfterRender',
        beforeclose: 'onPnl_xtm_ha_physical_linkBeforeClose'
    },
