...
Ext.define('SMC4ZEN.view.win_zen_device_set_before', {
    extend: 'Ext.window.Window',
    alias: 'widget.zen_device_set',

    requires: [
        'SMC4ZEN.view.win_zen_device_set_beforeViewModel',
        'Ext.form.Panel',
        'Ext.form.field.Text',
        'Ext.form.FieldSet',
        'Ext.form.Label',
                    ...
                    items: [
                        {
                            ...
                            labelWidth: 110,
                            listeners: {
                                errorchange: 'onFt_equipment_ipErrorChange'
                            }
                        },
                        {
                            xtype: 'textfield',
