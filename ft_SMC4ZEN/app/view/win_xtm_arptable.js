...
Ext.define('SMC4ZEN.view.win_xtm_arptable', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_xtm_arptableViewModel',
        'Ext.form.FieldSet',
        'Ext.ProgressBar',
        'Ext.button.Button',
        'Ext.grid.Panel',
    ...
    listeners: {
        afterrender: 'onWin_xtm_arptableAfterRender',
        destroy: 'onWin_xtm_arptableDestroy'
    },
