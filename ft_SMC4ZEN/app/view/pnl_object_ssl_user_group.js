...
Ext.define('SMC4ZEN.view.pnl_object_ssl_user_group', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_ssl_user_group',

    requires: [
        'SMC4ZEN.view.pnl_object_ssl_user_groupViewModel',
        'Ext.form.FieldSet',
    ...
    viewModel: {
        type: 'pnl_object_ssl_user_group'
    },
    border: false,
    height: 400,
    ...
    listeners: {
        afterrender: 'onPnl_object_ssl_user_groupAfterRender',
        beforedestroy: 'onPnl_object_ssl_user_groupBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('gridpanel[itemId="gpn_userGroup"]').bindStore(Ext.create('SMC4ZEN.store.st_SSLUserGroup'));
