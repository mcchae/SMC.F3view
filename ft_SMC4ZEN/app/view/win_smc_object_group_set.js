...
Ext.define('SMC4ZEN.view.win_smc_object_group_set', {
    extend: 'Ext.window.Window',
    alias: 'widget.smc_object_group_set',

    requires: [
        'SMC4ZEN.view.win_smc_object_group_setViewModel',
    ...
    listeners: {
        ...
        afterrender: 'onWin_smc_object_group_setAfterRender'
    },
