...
Ext.define('SMC4ZEN.view.pnl_object_svc_httpplus', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_svc_httpplus',

    requires: [
        'SMC4ZEN.view.pnl_object_svc_httpplusViewModel',
        'Ext.tab.Panel',
        'Ext.tab.Tab',
