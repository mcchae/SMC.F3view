...
Ext.define('SMC4ZEN.view.pnl_policy_search_rule_filter', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_policy_search_rule_filter',

    requires: [
        'SMC4ZEN.view.pnl_policy_search_rule_filterViewModel',
    ...
    viewModel: {
        type: 'pnl_policy_search_rule_filter'
    },
    collapsed: true,
    collapsible: true,
    title: '정책검색',
