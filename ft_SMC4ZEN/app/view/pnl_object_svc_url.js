...
Ext.define('SMC4ZEN.view.pnl_object_svc_url', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_svc_url',

    requires: [
        'SMC4ZEN.view.pnl_object_svc_urlViewModel',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                        tabchange: 'onTpn_basic_groupTabChange'
                                    }
                                }
                            ]
                        },
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                        tabchange: 'onTpn_deny_groupTabChange'
                                    }
                                }
                            ]
                        }
    ...
    listeners: {
        beforedestroy: 'onPnl_object_svc_urlBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('combobox[itemId="cmb_url_group"]').bindStore(Ext.create('SMC4ZEN.store.st_URL_Group'));
        me.down('combobox[itemId="cmb_url_group"]').select(me.down('combobox[itemId="cmb_url_group"]').getStore().getAt(0));
