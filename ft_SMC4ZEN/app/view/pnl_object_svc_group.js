...
Ext.define('SMC4ZEN.view.pnl_object_svc_group', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_svc_group',

    requires: [
        'SMC4ZEN.view.pnl_object_svc_groupViewModel',
        'Ext.form.field.Text',
        'Ext.tree.Panel',
        'Ext.tree.View',
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            handler: function(button, e) {
                                                ...
                                                var _kind = ['obj_svc_group', 'obj_svc_port', 'obj_svc_rpc', 'obj_svc_http'];
    ...
    listeners: {
        afterrender: 'onPnl_object_svc_groupAfterRender',
        beforedestroy: 'onPnl_object_svc_groupBeforeDestroy'
    },
