...
Ext.define('SMC4ZEN.view.pnl_xtm_network_ipmanage', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_network_ipmanageViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_network_ipmanageAfterRender',
        beforeclose: 'onPnl_xtm_network_ipmanageBeforeClose'
    },
            ...
            config = {
                items: [
                                        ...
                                        items: [
                                            {
                                                ...
                                                valueField: 'action',
                                                listeners: {
                                                    afterrender: 'onCmb_setAfterRender'
                                                }
                                            },
                                            {
                                                xtype: 'textfield',
                    ...
                    },
                    {
                        ...
                        margin: '0, 0, 10, 0',
                        listeners: {
                            afterrender: 'onCtn_ipmanager_controlAfterRender'
                        }
                    },
                    {
                        xtype: 'container',
                    ...
                    },
                    {
                        ...
                        listeners: {
                            itemclick: 'onGpn_ipmanager_setItemClick'
                        },
    ...
    onCmb_setAfterRender: function(component, eOpts) {
    ...
    onCmb_selectAfterRender: function(component, eOpts) {
        ...
        component.setValue('All Interface');
    },
    ...
    onPnl_xtm_network_ipmanageAfterRender: function(component, eOpts) {
        ...
        if(!allDevStore){
            ...
            allDevStore  = Ext.create('Ext.data.Store', {
    ...
    initStore: function() {
        ...
        this.down('[itemId=gpn_ipmanager_set]').bindStore(ipmanagerStore);
    },
