...
Ext.define('SMC4ZEN.view.win_rtm_device', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_rtm_deviceViewModel',
        'Ext.form.FieldSet',
        'Ext.form.Label',
    ...
    listeners: {
        afterrender: 'onId_window_gateAfterRender',
        destroy: 'onWin_rtm_deviceDestroy'
    },
    items: [
        {
            xtype: 'fieldset',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            valueField: 'code',
                            listeners: {
                                afterrender: 'onCmb_rtm_corpAfterRender'
                            }
                        },
                        {
                            xtype: 'container',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                render: 'onGpn_rtm_device_interfaceRender'
                            }
                        }
                    ]
                }
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                render: 'onGpn_rtm_device_bandwidthRender'
                            }
                        }
                    ]
                }
    ...
    onId_window_gateAfterRender: function(component, eOpts) {
        ...
        this.cid = grid.getSelection()[0].get('@cid');
        ...
        Ext.Ajax.request(
            {
                ...
                params :
                {
                    cid : Ext.encode(Ext.getCmp('gpn_rtm_devicelist').getSelection()[0].get('@cid'))
                },
    ...
    onCmb_rtm_corpAfterRender: function(component, eOpts) {
    ...
    onComboboxAfterRender1: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            'storeId' : 'st_rtm_ethlist',
            'fields' : [
                {	'name' : 'eth'			},
                {	'name' : 'inputValue'	}
            ],
            'data' : [
                {	'eth' : 'eth0', 'inputValue' : 1	},
                {	'eth' : 'eth1', 'inputValue' : 2	},
                {	'eth' : 'eth2', 'inputValue' : 4	},
                {	'eth' : 'eth3', 'inputValue' : 8	},
                {	'eth' : 'eth4', 'inputValue' : 16	},
                {	'eth' : 'eth5', 'inputValue' : 32	},
                {	'eth' : 'eth6', 'inputValue' : 64	},
                {	'eth' : 'eth7', 'inputValue' : 128	}
            ]
        }));
    ...
    onGpn_rtm_device_interfaceRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
    ...
    onGpn_rtm_device_bandwidthRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
    ...
    onButtonClick1: function(button, e, eOpts) {
        ...
        {
            checkNet += (st_interface.data.items[i].get('inputValue'));
        }
        ...
        {
            bandNet += (st_bandwidth.data.items[i].get('inputValue'));
        }
