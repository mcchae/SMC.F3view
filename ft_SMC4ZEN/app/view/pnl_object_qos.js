...
Ext.define('SMC4ZEN.view.pnl_object_qos', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_qos',

    requires: [
        'SMC4ZEN.view.pnl_object_qosViewModel',
        'Ext.form.FieldSet',
    ...
    listeners: {
        afterrender: 'onPnl_object_qosAfterRender',
        beforedestroy: 'onPnl_object_qosBeforeDestroy'
    },
    ...
    loadData: function(record) {
        ...
        me.down('combobox[itemId="cmb_interface"]').bindStore(Ext.create('SMC4ZEN.store.st_Object_Interface'));
