...
Ext.define('SMC4ZEN.view.pnl_xtm_system_snmp', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_system_snmpViewModel',
    ...
    listeners: {
        beforeclose: 'onPnl_xtm_system_snmpBeforeClose',
        afterrender: 'onPnl_xtm_system_snmpAfterRender'
    },
            ...
            config = {
                items: [
                    ...
                    },
                    {
                        ...
                        margin: '0, 0, 10, 0',
                        listeners: {
                            afterrender: 'onCtn_snmp_controlAfterRender'
                        }
                    },
                    {
                        xtype: 'gridpanel',
                        ...
                        listeners: {
                            itemclick: 'onGpn_snmp_setItemClick'
                        },
    ...
    initStore: function() {
        ...
        this.down('[itemId=gpn_snmp_set]').bindStore(snmpStore);
    }
