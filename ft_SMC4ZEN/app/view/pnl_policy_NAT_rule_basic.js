...
Ext.define('SMC4ZEN.view.pnl_policy_NAT_rule_basic', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_policy_nat_rule_basic',

    requires: [
        'SMC4ZEN.view.pnl_policy_NAT_rule_basicViewModel',
    ...
    viewModel: {
        type: 'pnl_policy_nat_rule_basic'
    },
    border: false,
    margin: '10,10,10,10',
    minWidth: 200,
            ...
            items: [
                {
                    ...
                    labelSeparator: ' ',
                    listeners: {
                        change: 'onChk_policy_NAT_useChange'
                    }
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    valueField: 'id',
                    listeners: {
                        change: 'onCb_policy_NAT_typeChange'
                    }
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    valueField: 'ifaceCid',
                    listeners: {
                        change: 'onCb_policy_NAT_ifaceChange',
                        select: 'onCb_policy_NAT_ifaceSelect'
                    }
                },
                {
                    xtype: 'toolbar',
            ...
            items: [
                {
                    ...
                    labelSeparator: ' ',
                    listeners: {
                        change: 'onTxt_policy_NAT_rule_basic_descChange'
                    }
                }
            ]
        }
    ...
    onCb_policy_NAT_ifaceSelect: function(combo, record, eOpts) {
        var me = this,
            _val = record.data;
