...
Ext.define('SMC4ZEN.view.pnl_object_user_group', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_user_group',

    requires: [
        'SMC4ZEN.view.pnl_object_user_groupViewModel',
        'Ext.form.field.Text',
        'Ext.tree.Panel',
        'Ext.tree.View',
    ...
    listeners: {
        afterrender: 'onPnl_object_user_groupAfterRender',
        beforedestroy: 'onPnl_object_user_groupBeforeDestroy'
    },
