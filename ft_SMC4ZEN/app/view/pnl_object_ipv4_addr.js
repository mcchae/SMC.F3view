...
Ext.define('SMC4ZEN.view.pnl_object_ipv4_addr', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_ipv4_addr',

    requires: [
        'SMC4ZEN.view.pnl_object_ipv4_addrViewModel',
        'Ext.form.field.Text',
        'Ext.form.FieldSet',
        'Ext.grid.Panel',
    ...
    listeners: {
        afterrender: 'onPnl_object_ipv4_addrAfterRender',
        beforedestroy: 'onPnl_object_ipv4_addrBeforeDestroy'
    },
