...
Ext.define('SMC4ZEN.view.pnl_setting_audit', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_setting_audit',

    requires: [
        'SMC4ZEN.view.pnl_setting_auditViewModel',
        'Ext.toolbar.Toolbar',
        'Ext.form.Label',
        'Ext.form.field.Date',
        'Ext.form.field.Time',
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                change: 'onCmb_audit_periodChange'
                            }
                        },
                        {
                            xtype: 'label',
                        ...
                        },
                        {
                            ...
                            handler: function(button, e) {
                                ...
                                {
                                    Ext.create('SMC4ZEN.store.st_SettingAudit');
                                    ...
                                    var grid = new Ext.grid.GridPanel({
                                        ...
                                        },
                                        {
                                            ...
                                            renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                ...
                                                if(record.data.object.op)
                                                obj_op = record.data.object.op;
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            width: 420,
                                            listeners: {
                                                checkchange: 'onTrpn_eventCheckChange'
                                            }
                                        }
                                    ]
                                },
    ...
    listeners: {
        show: 'onPnl_setting_auditShow',
        afterrender: 'onPnl_setting_auditAfterRender'
    },
    ...
    onPnl_setting_auditAfterRender: function(component, eOpts) {
        component.down('combobox[itemId="cmb_audit_period"]').bindStore(Ext.create('SMC4ZEN.store.st_SettingPeriod'));
        component.down('gridpanel[itemId="gpn_addOption"]').bindStore(Ext.create('SMC4ZEN.store.st_SettingAuditOption'));
        component.down('combobox[itemId="cmb_type"]').bindStore(Ext.create('SMC4ZEN.store.st_SettingAuditType'));
        Ext.create('SMC4ZEN.store.st_SettingAuditUser');
