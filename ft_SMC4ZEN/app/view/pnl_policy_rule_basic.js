...
Ext.define('SMC4ZEN.view.pnl_policy_rule_basic', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_policy_rule_basic',

    requires: [
        'SMC4ZEN.view.pnl_policy_rule_basicViewModel',
        'Ext.form.RadioGroup',
            ...
            items: [
                {
                    ...
                    labelWidth: 80,
                    listeners: {
                        change: 'onChk_policy_NAT_useChange1'
                    }
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    labelWidth: 80,
                    listeners: {
                        change: 'onChk_policy_rule_basic_directChange'
                    }
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            inputValue: 'IPSec',
                            listeners: {
                                change: 'onIPSecChange'
                            }
                        }
                    ],
                    listeners: {
                        change: 'onRbGrp_ploicy_rule_basic_actChange'
                    }
                },
                {
                    xtype: 'container',
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                change: 'onCb_policy_rule_adv_IPSECSAChange'
                            }
                        },
                        {
                            xtype: 'toolbar',
            ...
            items: [
                {
                    ...
                    valueField: 'log',
                    listeners: {
                        change: 'onCb_policy_rule_basic_logChange'
                    }
                },
                {
                    xtype: 'container',
            ...
            items: [
                {
                    ...
                    labelWidth: 80,
                    listeners: {
                        change: 'onTxt_policy_rule_basic_timeoutChange'
                    }
                },
                {
                    xtype: 'label',
            ...
            items: [
                {
                    ...
                    labelWidth: 80,
                    listeners: {
                        change: 'onTxt_policy_rule_basic_descChange'
                    }
                }
            ]
        }
    ...
    fn_view_init: function(_raw) {
        ...
        function bindList(node, vField, dField, comp, res, confName, isCheck){
             request_helper.xmlrpc_call_Ajax_Post(
                 SMC_SERVICE_NAME,
                 'getObjectList',
                 {g_cid : Ext.encode(node.cid),isRecursive : Ext.encode(true)},
                 function(response){
                     console.log('ipsec sa response - ', response);
        ...
        request_helper.xmlrpc_call_Ajax_Post(
            ...
            function(response){
                bindList(response, 'ipsecsaCid', 'ipsecsaName', _ipsec_cb, [], 'ipsecsa', true);
            }
        );
