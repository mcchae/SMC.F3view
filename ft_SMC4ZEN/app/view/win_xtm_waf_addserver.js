...
Ext.define('SMC4ZEN.view.win_xtm_waf_addserver', {
    extend: 'Ext.window.Window',

    requires: [
        'SMC4ZEN.view.win_xtm_waf_addserverViewModel',
    ...
    listeners: {
        afterrender: 'onWin_xtm_waf_addserverAfterRender'
    },
