...
Ext.define('SMC4ZEN.view.pnl_xtm_policy_setting', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_policy_settingViewModel',
        'SMC4ZEN.view.ctn_policy_control',
        'Ext.form.FieldSet',
        'Ext.grid.Panel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_security_settingAfterRender',
        beforeclose: 'onPnl_xtm_policy_settingBeforeClose'
    },
                                ...
                                items: [
                                    {
                                        ...
                                        listeners: {
                                            cellclick: 'onGpn_policy_filterpolicyCellClick'
                                        }
                                    }
                                ]
                            },
                                ...
                                items: [
                                    {
                                        ...
                                        valueField: 'eth',
                                        listeners: {
                                            afterrender: 'onCmb_vlanAfterRender'
                                        }
                                    },
                                    {
                                        xtype: 'container',
    ...
    onTxf_filterFocus1: function(component, event, eOpts) {
        // onTxf_filterFocus1 ===========================================================================================================================================================
        //
        // 일시 : 2014.08.29
        //
        ...
        var returnValue = Ext.create('SMC4ZEN.view.win_smc_object_set', {
    ...
    onTxf_filterFocus12: function(component, event, eOpts) {
        // onTxf_filterFocus12 ===========================================================================================================================================================
        //
        // 일시 : 2014.08.29
        //
    ...
    onTxf_filterFocus121: function(component, event, eOpts) {
    ...
    onTxf_filterFocus11: function(component, event, eOpts) {
    ...
    onTxf_filterFocus: function(component, event, eOpts) {
        Ext.create('SMC4ZEN.view.win_smc_object_set', {
    ...
    onCtn_policy_dpiFocus: function(component, event, eOpts) {
        Ext.create('SMC4ZEN.view.win_smc_object_set', {
    ...
    onTxf_urlFocus: function(component, event, eOpts) {
        Ext.create('SMC4ZEN.view.win_smc_object_set', {
    ...
    /*
        ...
        수 정 :
    */
    onTxf_ipFocus: function(component, event, eOpts) {
        Ext.create('SMC4ZEN.view.win_smc_object_set', {
    ...
    onTxf_policyFocus: function(component, event, eOpts) {
        Ext.create('SMC4ZEN.view.win_smc_object_set', {
    ...
    initStore: function() {
        var st_vlanlist = Ext.getStore('st_policy_vlan');

        st_vlanlist.removeAll();

        this.down('[itemId=fds_policy_vlan]').down('[itemId=gpn_policy_vlan]').bindStore(st_vlanlist);
    }
