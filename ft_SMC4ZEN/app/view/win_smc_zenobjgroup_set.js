...
Ext.define('SMC4ZEN.view.win_smc_zenobjgroup_set', {
    extend: 'Ext.window.Window',
    alias: 'widget.win_smc_zenobjgroup_set',

    requires: [
        'SMC4ZEN.view.win_smc_zenobjgroup_setViewModel',
