...
Ext.define('SMC4ZEN.view.pnl_xtm_multi_report', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_multi_reportViewModel',
        'Ext.form.FieldSet',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_multi_reportAfterRender',
