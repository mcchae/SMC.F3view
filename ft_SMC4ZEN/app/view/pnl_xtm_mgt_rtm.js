...
Ext.define('SMC4ZEN.view.pnl_xtm_mgt_rtm', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_mgt_rtmViewModel',
        'Ext.form.FieldSet',
                            ...
                            items: [
                                {
                                    ...
                                    valueField: 'value',
                                    listeners: {
                                        afterrender: 'onCmb_starttimeAfterRender'
                                    }
                                },
                                {
                                    xtype: 'combobox',
                                    ...
                                    valueField: 'value',
                                    listeners: {
                                        change: 'onCmb_endtimeChange',
                                        afterrender: 'onCmb_endtimeAfterRender'
                                    }
                                }
                            ]
                        }
    ...
    listeners: {
        beforerender: 'onPnl_xtm_mgt_rtmBeforeRender',
        afterrender: 'onPnl_xtm_mgt_rtmAfterRender',
        beforeclose: 'onPnl_xtm_mgt_rtmBeforeClose'
    },
    ...
    onCmb_starttimeAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            ...
            'data' : function(){
                ...
                for(var i = 0; i <= 23; i++){
                    ...
                    except_array.push({ 'value' : (i < 10) ? '0' + i + ':' + '00' : i + ':' + '00' });

                    if(i !== 23){

                        except_array.push({ 'value' : (i < 10) ? '0' + i + ':' + '30' : i + ':' + '30' });

                    }
                    else{

                        except_array.push({ 'value' : '23:59' });
        ...
        component.setValue({ 'value' : '00:00' });
    },
    ...
    onCmb_endtimeAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
        ...
        component.setValue({ 'value' : '23:59' });
    },

    onPnl_xtm_mgt_rtmBeforeRender: function(component, eOpts) {
        if(Ext.getStore('st_rtm_checketh')){

            Ext.create('SMC4ZEN.store.st_rtm_checketh');

        }

        if(Ext.getStore('st_rtm_checkbandwidth')){

            Ext.create('SMC4ZEN.store.st_rtm_checkbandwidth');
    ...
    initStore: function() {
        var component = this.componentStorage();
        var st_checketh = Ext.getStore('st_rtm_checketh');
        var st_checkband = Ext.getStore('st_rtm_checkbandwidth');

        st_checketh.removeAll();
        st_checkband.removeAll();

        component.checkethlist.bindStore(st_checketh);
        component.checkbandethlist.bindStore(st_checkband);
    }
