...
Ext.define('SMC4ZEN.view.pnl_objectList', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.pnl_objectList',

    requires: [
        'SMC4ZEN.view.pnl_objectListViewModel',
        'SMC4ZEN.view.pnl_objectListViewController',
        'SMC4ZEN.view.tool_smc_object_control',
    ...
    dockedItems: [
        {
            ...
            listeners: {
                afterrender: {
                    fn: 'onTool_smc_object_controlAfterRender',
                    scope: 'controller'
                }
            }
        },
            ...
            items: [
                {
                    ...
                    listeners: {
                        afterrender: {
                            fn: 'onCmb_ObjectConditionAfterRender',
                            scope: 'controller'
                        }
                    }
                },
                ...
                },
                {
                    ...
                    listeners: {
                        keypress: {
                            fn: 'onTxf_ObjectSearchTextKeypress',
                            scope: 'controller'
                        }
                    }
                },
    ...
    listeners: {
        afterrender: {
            fn: 'onPnl_objectListAfterRender',
            scope: 'controller'
        }
    },
                ...
                items: [
                    {
                        ...
                        listeners: {
                            itemdblclick: 'onGpn_objectListItemDblClick',
                            afterrender: 'onGpn_objectListAfterRender'
                        },
    ...
    onGpn_objectListAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('SMC4ZEN.store.st_ObjectGrid'));
        component.down('pagingtoolbar[itemId="ptb_objectList"]').bindStore(component.getStore());
            ...
            function(response){
                ...
                request_helper.xmlrpc_call_Ajax_Post(
                    ...
                    function(response2){
                        ...
                        Ext.create('SMC4ZEN.view.pnl_object_hierarchy').loadData(record.data, response, response2);
                    }
                );
            }
        );
    ...
    addScript: function() {
        ...
        if(record)
        {
            object_window = Ext.create('SMC4ZEN.view.pnl_object_script');
    ...
    onTreeNodeAdd: function(thisnode, newnode, ref) {
        ...
        if(thisnode.raw['cid'] && newnode.raw['cid'])
        {
            if(thisnode.raw['cid'] !== newnode.raw['cid'])
            {
                var _svc = 'ftSMC',
                ...
                request_helper.xmlrpc_call_Ajax_Post(
                    ...
                    function(response){
                        ...
                        if(response)
                        {
                            _treeTarget.set_obj_tree(newnode.raw);
                        }
                    }
                );
            }
