...
Ext.define('SMC4ZEN.view.pnl_xtm_route_policy', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_route_policyViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_route_policyAfterRender',
        beforeclose: 'onPnl_xtm_route_policyBeforeClose'
    },
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                margin: '10, 0, 10, 0',
                                listeners: {
                                    afterrender: 'onCtn_policy_controlAfterRender'
                                }
                            },
                            {
                                xtype: 'container',
