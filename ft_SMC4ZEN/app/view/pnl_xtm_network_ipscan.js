...
Ext.define('SMC4ZEN.view.pnl_xtm_network_ipscan', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_network_ipscanViewModel',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_network_ipscanAfterRender',
        beforeclose: 'onPnl_xtm_network_ipscanBeforeClose'
    },
            ...
            config = {
                items: [
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        valueField: 'type',
                                        listeners: {
                                            afterrender: 'onCmb_scantypeAfterRender'
                                        }
                                    }
                                ]
                            },
                                ...
                                items: [
                                    {
                                        ...
                                        valueField: 'value',
                                        listeners: {
                                            afterrender: 'onCmb_cycleAfterRender',
                                            change: 'onCmb_cycleChange'
                                        }
                                    },
                                    {
                                        xtype: 'numberfield',
                    ...
                    },
                    {
                        ...
                        listeners: {
                            itemclick: 'onGpn_ipscan_setItemClick'
                        },
    ...
    onCmb_scantypeAfterRender: function(component, eOpts) {
        ...
        component.setValue('ARP');
    },

    onCmb_cycleAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
    ...
    initStore: function() {
        ...
        this.down('[itemId=gpn_ipscan_set]').bindStore(ipscanStore);
    }
