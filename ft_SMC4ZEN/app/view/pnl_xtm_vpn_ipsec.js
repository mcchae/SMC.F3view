...
Ext.define('SMC4ZEN.view.pnl_xtm_vpn_ipsec', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_vpn_ipsecViewModel',
        'Ext.form.FieldSet',
        'Ext.grid.Panel',
            ...
            items: [
                {
                    ...
                    listeners: {
                        selectionchange: 'onGpn_ipsec_setSelectionChange',
                        beforeselect: 'onGpn_ipsec_setBeforeSelect'
                    }
                },
                {
                    xtype: 'container',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_vpn_ipsecAfterRender',
        beforeclose: 'onPnl_xtm_vpn_ipsecBeforeClose'
    },
    ...
    onTxf_hostFocus: function(component, event, eOpts) {
    ...
    onTxf_listFocus: function(component, event, eOpts) {
        Ext.create('SMC4ZEN.view.win_smc_object_set', {
    ...
    initStore: function() {
        ...
        this.down('[itemId=fds_vpn_ipsec]').down('[itemId=gpn_ipsec_set]').bindStore(ipsecStore);
    }
