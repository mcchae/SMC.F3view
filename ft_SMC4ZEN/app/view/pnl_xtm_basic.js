...
Ext.define('SMC4ZEN.view.pnl_xtm_basic', {
    extend: 'Ext.panel.Panel',

    requires: [
        'SMC4ZEN.view.pnl_xtm_basicViewModel',
        'Ext.form.FieldSet',
                    ...
                    items: [
                        {
                            ...
                            valueField: 'value',
                            listeners: {
                                afterrender: 'onCmb_groupinfoAfterRender'
                            }
                        },
                        {
                            xtype: 'combobox',
                            ...
                            valueField: 'area',
                            listeners: {
                                afterrender: 'onCmb_areaAfterRender'
                            }
                        },
                        {
                            xtype: 'textfield',
    ...
    listeners: {
        afterrender: 'onPnl_xtm_basicAfterRender',
        beforeclose: 'onPnl_xtm_basicBeforeClose'
    },

    onCmb_groupinfoAfterRender: function(component, eOpts) {
        component.bindStore(Ext.create('Ext.data.Store', {
            'storeId' : 'st_basic_corpinfo',
            'fields' : [
                {	'name' : 'name'		},
                {	'name' : 'value'	}
            ],
            'data' : [
                {	'name' : '농축협'	, 'value' : 'NH_NLCF'	},
                {	'name' : '중앙회'	, 'value' : 'NH_NACF'	},
                {	'name' : '농협은행'	, 'value' : 'NH_BANK'	},
                {	'name' : '기타'	 , 'value' : 'NH_ETC'	}
            ]

        }));

        component.setValue('NH_ETC');
    },
    ...
    */
    ...
    onCmb_checkintervalBlur: function(component, event, eOpts) {
        // onTxf_ipBlur ==================================================================================================================================================================
        //
        // 일시 : 2015.01.06
        //
        // 설명 : 데이터가 없을 경우 자동으로 1을 컴포넌트에 설정합니다.
        //
        // 수정 :
        //
        // ===============================================================================================================================================================================
    ...
    validityCheck: function() {
        ...
        var validCheckObj = {
            ...
            'basicIpCheck' : function(){
                ...
                if(component.fds_autoup.checkboxCmp.getValue() && component.auto_ip.getValue() !== '' && !component.auto_ip.validate()){
                ...
                if(component.fds_autoup.checkboxCmp.getValue() && component.auto_mackey.getValue() !== '' && !component.auto_mackey.validate()){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : 'MAC 문자열의 범위는 1 ~ 64 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
            ...
            'basicPortCheck' : function(){
                ...
                if(component.fds_autoup.checkboxCmp.getValue() && !component.auto_port.validate()){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '포트의 범위는 1024 ~ 65535 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
