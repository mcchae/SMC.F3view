...
Ext.define('SMC4ZEN.view.pnl_object_ipv6_header', {
    extend: 'Ext.window.Window',
    alias: 'widget.pnl_object_ipv6_header',

    requires: [
        'SMC4ZEN.view.pnl_object_ipv6_headerViewModel',
        'Ext.form.FieldSet',
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    handler: function(button, e) {
                                                        Ext.create('SMC4ZEN.view.pnl_object_select').loadData('obj_ip');
                                                    },
                                                    flex: 0.5,
                                                    margin: '1 10 1 10',
                                                    maxWidth: 100,
    ...
    listeners: {
        afterrender: 'onPnl_object_ipv6_headerAfterRender',
        beforedestroy: 'onPnl_object_ipv6_headerBeforeDestroy'
    },
