...
Ext.define('SMC.view.pnl_policy_group', {
                    ...
                    dockedItems: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    height: 24,
                                    itemId: 'iid_btn_refresh',
                                    width: 24,
                                    tooltip: '새로고침',
                                    listeners: {
                                        click: {
                                            fn: me.onButtonClick91,
                                            scope: me
                                        }
                                    }
                                }
                    ...
                    items: [
                        {
                            ...
                            viewConfig: {
                                ...
                                listeners: {
                                    beforedrop: {
                                        fn: me.onTrv_policy_groupBeforeDrop,
                                        scope: me
                                    }
                                }
                            },
    ...
    onButtonClick91: function(button, e, eOpts) {
        var me = this;

        me.fn_tree_init();
    },

    onTrv_policy_groupBeforeDrop: function(node, data, overModel, dropPosition, dropHandlers, eOpts) {
    ...
    onGpnl_policy_listAfterRender: function(component, eOpts) {
        ...
        var policy_Context_Array = [
            ...
            {
                'name' : '정책 전송',
                'itemId' : 'id_sendpolicy',
                'children' : [
                    {
                        'name' : '연결 장비 정책 전송',
                        'itemId' : 'id_ref_sendpolicy',
                        'children' : null,
                        'callback' : function(){

                            var gpn_policylist = Ext.ComponentQuery.query('gridpanel[itemId=gpnl_policy_list]')[0];
                            var sel_policydata = gpn_policylist.getSelectionModel().getSelection();

                            var arr_cid = [];

                            for(var i = 0, max = sel_policydata.length; i < max; i++){

                                arr_cid.push(sel_policydata[i].data['@cid']);
        ...
        var contextCallback = function(menuInstance){
            ...
            if(_len > 0)
            {
                ...
                menuInstance.down('[itemId=id_ref_sendpolicy]').enable();
            ...
            else
            {
                ...
                menuInstance.down('[itemId=id_policyCompile]').disable();
                menuInstance.down('[itemId=id_ref_sendpolicy]').disable();
            }
