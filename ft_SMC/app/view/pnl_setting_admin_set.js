...
Ext.define('SMC.view.pnl_setting_admin_set', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                            ...
                            items: [
                                {
                                    ...
                                    listeners: {
                                        errorchange: {
                                            fn: me.onTextfieldErrorChange11,
                                            scope: me
                                        }
                                    }
                                },
                                    ...
                                    items: [
                                        {
                                            ...
                                            validator: function(value) {
                                                ...
                                                var txt_email = Ext.getCmp('ft_email').getValue();
                                                var txt_phone = Ext.getCmp('ft_phone').getValue();
                                                if(!passwordCheck3( txt_id, value)){ return get_msg('err_pw3');}
                                                if(!passwordCheck3( txt_email, value)){ return get_msg('err_pw3');}
                                                if(!passwordCheck3( txt_phone, value)){ return get_msg('err_pw3');}
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                keydown: {
                                                    fn: me.onTextfieldKeydown3,
                                                    scope: me
                                                },
                                                errorchange: {
                                                    fn: me.onTextfieldErrorChange3,
                                                    scope: me
                                                }
                                            }
                                        },
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                keydown: {
                                                    fn: me.onTextfieldKeydown4,
                                                    scope: me
                                                },
                                                errorchange: {
                                                    fn: me.onTextfieldErrorChange4,
                                                    scope: me
                                                }
                                            }
                                        }
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                keydown: {
                                                    fn: me.onTextfieldKeydown5,
                                                    scope: me
                                                },
                                                errorchange: {
                                                    fn: me.onTextfieldErrorChange5,
                                                    scope: me
                                                }
                                            }
                                        }
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_setting_admin_setAfterRender,
                    scope: me
                }
            }
        });
