...
Ext.define('SMC.view.pnl_object_select', {
                            ...
                            items: [
                                {
                                    ...
                                    getGridList: function(record) {
                                        ...
                                        if(record.raw._kind === 'obj_dev_xtm' || record.raw._kind === 'obj_ip_v6_addr' || record.raw._kind === 'obj_ip_v6_group' || record.raw._kind === 'obj_ssl_svr_group')
                                        {
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                itemdblclick: {
                                                    fn: me.onGpn_object_gridItemDblClick,
                                                    scope: me
                                                }
                                            },
                                            dockedItems: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, e) {
                                                        ...
                                                        if(search_name)
                                                        {
                                                            ...
                                                            else if(me.object_type === 'obj_dev' || me.object_type === 'obj_dev_compile')
                                                            {
                                                                _func = 'getDeviceList';
                                                                _kind = ['obj_dev_xtm'];
                                                            }
        ...
        if(select_grid)
        {
            switch(me.object_type)
            {
                ...
                case 'obj_dev':
                    ...
                    break;
                case 'obj_dev_compile':
                    var wnd_gate = Ext.ComponentQuery.query('window[itemId="win_object_ipsec_compile"]')[0];
