...
Ext.define('SMC.view.win_xtm_vpn_branch_office', {
    extend: 'Ext.window.Window',
    alias: 'widget.win_xtm_vpn_branch_office',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            listeners: {
                                                render: {
                                                    fn: me.onGpn_vpnbranch_primaryRender,
                                                    scope: me
                                                }
                                            }
                                        }
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            listeners: {
                                                render: {
                                                    fn: me.onGpn_vpnbranch_backupRender,
                                                    scope: me
                                                }
                                            }
                                        }
            ...
            listeners: {
                afterrender: {
                    fn: me.onWin_xtm_vpn_branch_officeAfterRender,
                    scope: me
                }
            }
        });
