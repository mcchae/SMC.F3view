...
Ext.define('SMC.view.pnl_xtm_system_basic', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_system_basic',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                                    ...
                                    items: [
                                        {
                                            ...
                                            displayField: 'name',
                                            queryMode: 'local',
                                            store: 'st_system_basic_uselimit',
                                            valueField: 'value'
                                        }
                                    ]
                                }
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_system_basicAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_system_basicBeforeClose,
                    scope: me
                }
            }
        });
    ...
    validityCheck: function() {
        ...
        var validCheckObj = {
            ...
            'optionBlankCheck' : function(){
                ...
                if(component.connport.getValue() === null){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : 'Web SMC 접속포트는 필수항목 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(component.sshport.getValue() === null){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : 'SSH 접속포트는 필수항목 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(component.session.getValue() === null){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '최대 세션 사용률 제한은 필수항목 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(component.memory.getValue() === null){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '최대 메모리 사용률 제한은 필수항목 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
            ...
            'optionScopeCheck' : function(){
                ...
                if(!component.connport.validate()){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : 'Web SMC 접속포트의 범위는 0 ~ 65535 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(!component.sshport.validate()){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : 'SSH 접속포트의 범위는 0 ~ 65535 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
    ...
    saveData: function() {
        ...
        // 옵션 validation check 추가 20150916 ==========================================================================================================================================

        if(!this.validityCheck().optionBlankCheck() || !this.validityCheck().optionScopeCheck()){

            return false;

        }

        if(!component.session.disabled){

            if(!component.session.validate()){

                Ext.Msg.show({

                    title : 'WeGuardia™ SMC 2.0',
                    msg : '최대 세션 사용률의 범위는 0, 10 ~ 100 % 입니다.',
                    buttons : Ext.Msg.OK,
                    icon : Ext.Msg.ERROR
                ...
                var max_session = component.session.getValue();

                if(max_session > 0 && max_session < 10){
        ...
        if(!component.memory.disabled){

            if(!component.memory.validate()){

                Ext.Msg.show({

                    title : 'WeGuardia™ SMC 2.0',
                    msg : '최대 메모리 사용률의 범위는 0, 10 ~ 100 % 입니다.',
                    buttons : Ext.Msg.OK,
                    icon : Ext.Msg.ERROR
                ...
                var max_memory = component.memory.getValue();

                if(max_memory > 0 && max_memory < 10){
