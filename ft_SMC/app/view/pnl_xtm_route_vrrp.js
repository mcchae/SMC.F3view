...
Ext.define('SMC.view.pnl_xtm_route_vrrp', {
                            ...
                            items: [
                                {
                                    ...
                                    listeners: {
                                        afterrender: {
                                            fn: me.onCmb_rummodeAfterRender,
                                            scope: me
                                        },
                                        change: {
                                            fn: me.onCmb_rummodeChange,
                                            scope: me
                                        }
                                    }
                                },
    ...
    onCmb_rummodeAfterRender: function(component, eOpts) {
    ...
    onCmb_rummodeChange: function(field, newValue, oldValue, eOpts) {
        if(newValue === 'backup'){
    ...
    onCtn_vrrp_controlAfterRender: function(component, eOpts) {
        ...
        btn_add.on('click', function(){
            ...
            if(!me.validityCheck().vrrpBlankCheck() || !me.validityCheck().vrrpValidateCheck() || !me.validityCheck().vrrpDuplicationCheck(componentObj.groupid.getValue(), 'add')){
            ...
            obj['@num'] = 0;
            obj.boostup = (componentObj.modeSelect.getValue() === 'backup')? componentObj.failOver.down('[itemId=nfd_boostup]').getValue() : null;
            ...
            settingObj['@mode']        = (componentObj.modeSelect.getValue() === 'master') ? "master" : (componentObj.modeSelect.getValue() === 'backup') ? "backup" : null;
        ...
        btn_mod.on('click', function(){
            ...
            if(!me.validityCheck().vrrpBlankCheck() || !me.validityCheck().vrrpValidateCheck() || !me.validityCheck().vrrpDuplicationCheck(componentObj.groupid.getValue(), 'modify')){
    ...
    onGpn_vrrp_gridItemClick: function(dataview, record, item, index, e, eOpts) {
        ...
        control2.down('[itemId=cmb_runmode]').setValue((record.data.setting['@mode'] === null) ? 'none' : record.data.setting['@mode']);
    ...
    componentStorage: function() {
        ...
        var modeSelect = failOver.down('[itemId=cmb_runmode]');
    ...
    validityCheck: function() {
        ...
        var validCheckObj = {
            ...
            vrrpBlankCheck : function(){
                ...
                if(component.failOver.down('[itemId=nfd_boostup]').getValue() === null && (component.modeSelect.getValue() === 'backup')){
            ...
            vrrpValidateCheck : function(){
                ...
                if(!component.failOver.down('[itemId=nfd_boostup]').validate() && (component.modeSelect.getValue() === 'backup')){
