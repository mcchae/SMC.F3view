...
Ext.define('SMC.view.win_xtm_ipmlist', {
    extend: 'Ext.window.Window',
    alias: 'widget.xtm_ipmlist',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            listeners: {
                afterrender: {
                    fn: me.onWin_xtm_ipmlistAfterRender,
                    scope: me
                },
                destroy: {
                    fn: me.onWin_xtm_ipmlistDestroy,
                    scope: me
                }
            },
            items: [
