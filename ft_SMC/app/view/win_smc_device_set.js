...
Ext.define('SMC.view.win_smc_device_set', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                ...
                show: {
                    fn: me.onWin_smc_device_setShow,
                    scope: me
                }
            }
        });
    ...
    onWin_smc_device_setBeforeDestroy: function(component, eOpts) {
        ...
        var bondonlyEthStore = Ext.getStore('st_common_bondonlyeth');
        ...
        bondonlyEthStore.loadData(ethArray);
    ...
    onWin_smc_device_setShow: function(component, eOpts) {
        // onWin_smc_device_setShow ===============================================================================================================================================
        //
        // 일시 : 2015.09.20
        //
        // 설명 : 타인이 수정 중인 장비를 열 때 수정 중임을 알 수 있도록 메시지를 띄우고 장비를 읽기 전용으로 수정
        //
        // ===============================================================================================================================================================================

        if(component.deviceParams._locked){

            Ext.Msg.show({

                title : 'WeGuardia™ SMC 2.0',
                msg : '해당 장비는 ' + component.deviceParams._locked + '에서</br> 사용중인 장비이므로 수정할 수 없습니다.',
                buttons : Ext.Msg.OK,
                alwaysOnTop : true,
                icon : Ext.Msg.INFO
            ...
            component.setTitle(component.title + ' [읽기 전용]');

            component.down('button[itemId="bt_save"]').disable();
        }
    },
