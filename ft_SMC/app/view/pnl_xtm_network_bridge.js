...
Ext.define('SMC.view.pnl_xtm_network_bridge', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_network_bridge',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                            ...
                            items: [
                                {
                                    ...
                                    listeners: {
                                        change: {
                                            fn: me.onCmb_bridgememberChange,
                                            scope: me
                                        }
                                    }
                                },
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                itemclick: {
                                    fn: me.onGpn_bridge_setItemClick,
                                    scope: me
                                }
                            }
                        }
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_network_bridgeAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_network_bridgeBeforeClose,
                    scope: me
                }
            }
        });
    ...
    onId_cb_useSTPChange: function(field, newValue, oldValue, eOpts) {
        ...
        if(newValue)    learningtime.setDisabled(false);
        else            learningtime.setDisabled(true);
    ...
    onCtn_bridge_controlAfterRender: function(component, eOpts) {
        ...
        // ==============================================================================================================================================================================
            ...
            addInterface(componentObj.bridgegrid.getStore(), Ext.getStore('st_common_totaleth'), 'name');
    ...
    componentStorage: function() {
        ...
        var ctn_grid         = this.down('[itemId=ctn_bridge_grid]');
    ...
    validityCheck: function() {
        ...
        var bridgeGrid  = this.down('[itemId=ctn_bridge_grid]').down('[itemId=gpn_bridge_set]');
