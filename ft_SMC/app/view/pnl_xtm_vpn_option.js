    ...
    onPnl_xtm_vpn_optionAfterRender: function(component, eOpts) {
        ...
        try{
            ...
            if(deviceData){
                ...
                var ip = deviceData.vpn_xauth_pool_ip;
                var netmask = deviceData.vpn_xauth_pool_mask;

                componentObj.ip.setValue(ip ? ip : "0.0.0.0");
                componentObj.netmask.setValue(netmask ? netmask : "0.0.0.0");
