...
Ext.define('SMC.view.pnl_xtm_route_multicast', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_route_multicast',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                                                    ...
                                                    items: [
                                                        {
                                                            ...
                                                            listeners: {
                                                                change: {
                                                                    fn: me.onCmb_multicast_ethChange,
                                                                    scope: me
                                                                }
                                                            }
                                                        }
                                                    ...
                                                    items: [
                                                        {
                                                            ...
                                                            title: '',
                                                            hideHeaders: true,
                                                            store: 'st_route_multicast_ethlist',
                                                            columns: [
                                                                {
                                                                    xtype: 'gridcolumn',
                                                                    dataIndex: 'eth',
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_route_multicastAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_route_multicastBeforeClose,
                    scope: me
                }
            }
        });
