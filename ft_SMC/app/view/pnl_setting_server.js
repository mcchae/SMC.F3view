...
Ext.define('SMC.view.pnl_setting_server', {
    ...
    loadData: function() {
        ...
        // 2015.09.23 김민수 - SMC 버전정보를 가져오는 AJAX 코드 추가
        ...
        request_helper.xmlrpc_call_Ajax_Post(
            ...
            function(res){
                ...
                if(res === 'unknown'){
                    ...
                    me.down('textfield[itemId="txf_version"]').setValue('버전 정보를 읽을 수 없습니다.');

                }
                else{

                    me.down('textfield[itemId="txf_version"]').setValue(res);
