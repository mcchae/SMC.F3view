...
Ext.define('SMC.view.pnl_xtm_vpn_head_office', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_vpn_head_office',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_vpn_head_officeAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_vpn_head_officeBeforeClose,
                    scope: me
                }
            }
        });
