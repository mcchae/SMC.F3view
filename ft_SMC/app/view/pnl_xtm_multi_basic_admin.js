...
Ext.define('SMC.view.pnl_xtm_multi_basic_admin', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_multi_basic_admin',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                afterrender: {
                                    fn: me.onCtn_multimanager_controlAfterRender,
                                    scope: me
                                }
                            }
                        },
                        {
                            ...
                            listeners: {
                                itemclick: {
                                    fn: me.onGpn_manager_usergridItemClick1,
                                    scope: me
                                }
                            }
                        }
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_multi_basic_adminAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_multi_basic_adminBeforeClose,
                    scope: me
                }
            }
        });
    ...
    initStore: function() {
        Ext.getStore('st_multimanager_list').removeAll();
    }
