...
Ext.define('SMC.view.win_xtm_alg_ftp', {
    extend: 'Ext.window.Window',
    alias: 'widget.win_xtm_alg_ftp',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                        itemclick: {
                                            fn: me.onGpn_alg_userlistItemClick,
                                            scope: me
                                        }
                                    }
                                }
            ...
            listeners: {
                afterrender: {
                    fn: me.onWin_xtm_alg_ftpAfterRender,
                    scope: me
                },
                beforedestroy: {
                    fn: me.onWin_xtm_alg_ftpBeforeDestroy,
                    scope: me
                }
            }
        });
    ...
    onWin_xtm_alg_ftpAfterRender: function(component, eOpts) {
        ...
        for(var i = 0; i < devStore.count(); i++){
            ...
            Ext.getStore('st_alg_interface').add({	'eth' : devStore.getAt(i).get('eth')	});

        }

        Ext.getStore('st_alg_interface').insert(0, {	'eth' : 'all'	});
    ...
    initStore: function() {
        ...
        // 일시 : 2014.09.01
        //
        // 설명 : 화면에서 사용하는 스토어를 초기화 합니다.
        //
        // ==============================================================================================================================================================================

        Ext.getStore('st_alg_userlist').removeAll();
        Ext.getStore('st_alg_interface').removeAll();
    }
