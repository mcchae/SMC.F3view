...
Ext.define('SMC.view.pnl_xtm_multi_monitor', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_multi_monitor',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_multi_monitorAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_multi_monitorBeforeClose,
                    scope: me
                }
            }
        });
