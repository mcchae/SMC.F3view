...
Ext.define('SMC.view.pnl_xtm_network_bonding', {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    validator: function(value) {
                                        var retValue = LengthCheck(value, 0, 1000);
                                ...
                                },
                                {
                                    xtype: 'numberfield',
                                    validator: function(value) {
                                        var retValue = LengthCheck(value, 0, 5000);
    ...
    onCtn_bonding_controlAfterRender: function(component, eOpts) {
        ...
        bt_add.on('click', function(){
            ...
            if(!me.validityCheck().blankCheck() || !me.validityCheck().bondDuplicationCheck(componentObj.bondingname.getValue(), 'add') || !me.validityCheck().memberDuplicationCheck('add') || !me.validityCheck().validCheck()){
            ...
            if(componentObj.runmode.getRawValue() === 'Round Robin'   || componentObj.runmode.getRawValue() === 'Active Backup' || componentObj.runmode.getRawValue() === 'Balance XOR'){
            ...
            //     addInterface(componentObj.bondgrid.getStore(), Ext.getStore('st_common_bondeth'), 'name');
            addInterface(componentObj.bondgrid.getStore(), Ext.getStore('st_common_bondonlyeth'), 'name');
            addInterface(componentObj.bondgrid.getStore(), Ext.getStore('st_common_alleth'), 'name');
            addInterface(componentObj.bondgrid.getStore(), Ext.getStore('st_common_totaleth'), 'name');
        ...
        bt_mod.on('click', function(){
            ...
            if(!me.validityCheck().blankCheck() || !me.validityCheck().bondDuplicationCheck(componentObj.bondingname.getValue(), 'modify') || !me.validityCheck().memberDuplicationCheck('modify') || !me.validityCheck().validCheck()){
            ...
            //                  componentObj.bondgrid.getSelectionModel().getSelection()[0].get('name'),
            //                  componentObj.bondingname.getValue());

            modInterface(Ext.getStore('st_common_bondonlyeth'),
                         componentObj.bondgrid.getSelectionModel().getSelection()[0].get('name'),
                         componentObj.bondingname.getValue());
        ...
        bt_del.on('click', function(){
            ...
            for(var i = 0; i < delRecord.length; i++){
                ...
                delInterface(Ext.getStore('st_common_bondonlyeth'), delRecord[i].data.name);
    ...
    onGpn_bonding_setItemClick: function(dataview, record, item, index, e, eOpts) {
        ...
        componentObj.runmode.setValue(record.data.mode);
    ...
    validityCheck: function() {
        ...
        var validCheckObj = {
            ...
            blankCheck : function(){
                ...
                // 링크 모니터링, 업 딜레이, 다운 딜레이, ARP 주기 blank check 추가 20150917
                if(component.linkmonitering.getValue() === null){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '링크 모니터링 주기는 필수항목 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(component.updelay.getValue() === null){
                ...
                if(component.downdelay.getValue() === null){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '다운 딜레이는 필수항목 입니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
            ...
            // 링크 모니터링, 업 딜레이, 다운 딜레이, ARP 주기 validation check 추가 20150917
            validCheck : function(){

                if(!component.linkmonitering.validate()){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '링크 모니터링 주기는 0~1000 사이의 정수만 입력이 가능합니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(!component.updelay.validate()){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '업 딜레이 주기는 0~1000 사이의 정수만 입력이 가능합니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(!component.downdelay.validate()){

                    Ext.Msg.show({

                        title : 'WeGuardia™ SMC 2.0',
                        msg : '다운 딜레이 주기는 0~1000 사이의 정수만 입력이 가능합니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
                ...
                if(!component.period.validate()){
                    ...
                    Ext.Msg.show({
                        ...
                        title : 'WeGuardia™ SMC 2.0',
                        msg : 'ARP 주기는 0~5000 사이의 정수만 입력이 가능합니다.',
                        buttons : Ext.Msg.OK,
                        icon : Ext.Msg.ERROR
