...
Ext.define('SMC.view.pnl_xtm_mgt_monitor', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_mgt_monitor',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_mgt_monitorAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_mgt_monitorBeforeClose,
                    scope: me
                }
            }
        });
