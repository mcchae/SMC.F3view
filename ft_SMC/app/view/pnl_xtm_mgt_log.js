...
Ext.define('SMC.view.pnl_xtm_mgt_log', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_mgt_log',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                itemclick: {
                                    fn: me.onGpn_logset_ipItemClick,
                                    scope: me
                                }
                            }
                        }
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_mgt_logAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_mgt_logBeforeClose,
                    scope: me
                }
            }
        });
