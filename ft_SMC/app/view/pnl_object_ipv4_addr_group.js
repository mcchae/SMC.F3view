...
Ext.define('SMC.view.pnl_object_ipv4_addr_group', {
    ...
    border: false,
    height: 550,
    itemId: 'pnl_object_ipv4_addr_group',
    minHeight: 550,
    minWidth: 1000,
    padding: '0 20 10 20',
    width: 1200,
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            getGridList: function(type, data, option) {
                                                var me = this.up('window[itemId="pnl_object_ipv4_addr_group"]');
                                            ...
                                            searchObject: function(g_cid, object_store, object_grid, object_tree, select_data) {
                                                ...
                                                var ctn_group = me.down('container[itemId="ctn_ipv4_group"]');
                                            ...
                                            set_obj_tree: function(new_group) {
                                                ...
                                                treeObj.up('container[itemId="ctn_ipv4_group"]').setLoading(true);
                                                ...
                                                function(response){
                                                    ...
                                                    treeObj.up('container[itemId="ctn_ipv4_group"]').setLoading(false);

                                                    for(var i=0; i<response.children.length; i++)
                                                    {
                                                        if(response.children[i].gtype === 'obj_ip_v4_group')
                                                        {
                                                            treeObj.up('window[itemId="pnl_object_ipv4_addr_group"]')['@groupcid'] = response.children[i].cid;
                                                        }

                                                        if(response.children[i].gtype !== 'obj_ip_v4_group' && response.children[i].gtype !== 'obj_ip_v4_addr')
                                                        {
                                                    ...
                                                    if(new_group)
                                                    {
                                                        treeObj.getSelectionModel().store.each(function(data, idx){
                                                            ...
                                                            {
                                                                treeObj.up('window[itemId="pnl_object_ipv4_addr_group"]').down('gridpanel[itemId=gpn_object_grid]').searchChildGroup(new_group.cid, data.childNodes);
                                                                return false;
                                                            }
                                                            else if(new_group._kind.indexOf(data.raw.gtype) > -1)
                                                            {
                                                                if(data.childNodes.length > 0)
                                                                {
                                                                    for(var i=0; i<data.childNodes.length; i++)
                                                                    {
                                                                        ...
                                                                        {
                                                                            treeObj.up('window[itemId="pnl_object_ipv4_addr_group"]').down('gridpanel[itemId=gpn_object_grid]').searchChildGroup(new_group.cid, data.childNodes[i].childNodes);
                                                                            return false;
                                                                        }
                                                                    }
                                                                }
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            findObjectList: function(treeSel, chkCond, searchKey, searchValue) {
                                                ...
                                                if(searchValue){
                                                    ...
                                                    if(searchKey === 'IPaddr'){
                                                        if(!validIPForm(condition.ip, 'v4'))
                                                        {
                                                            alertMessage('IP형식이 올바르지 않습니다.');
                                                            return false;
                                                        }
                                                    }
                                                    ...
                                                    if(treeSel){
                                                        ...
                                                        condition.kind = ['obj_ip_v4_addr', 'obj_ip_v4_group'];
                                                    }
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    listeners: {
                                                        afterrender: {
                                                            fn: me.onCmb_ObjectConditionAfterRender,
                                                            scope: me
                                                        }
                                                    }
                                                },
                                                ...
                                                },
                                                {
                                                    ...
                                                    listeners: {
                                                        keypress: {
                                                            fn: me.onTxf_ObjectSearchTextKeypress1,
                                                            scope: me
                                                        }
                                                    }
                                                },
                                                {
                                                    ...
                                                    handler: function(button, e) {
                                                        var treeSel = this.up('window[itemId=pnl_object_ipv4_addr_group]').down('treepanel[itemId="trpn_object_tree"]').getSelectionModel().getSelection()[0];
                                        ...
                                        },
                                        {
                                            ...
                                            gridRefresh: function(type, data, option) {
                                                ...
                                                var me = _grid.up('window[itemId=pnl_object_ipv4_addr_group]');
                                            ...
                                            searchChildGroup: function(cid, childNodes) {
                                                var treeObj = this.up('window[itemId=pnl_object_ipv4_addr_group]').down('treepanel[itemId="trpn_object_tree"]');
                                            ...
                                            items: [
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, e) {
                                                        var me = button.up('window[itemId="pnl_object_ipv4_addr_group"]');
                                                        ...
                                                        if(record)
                                                        {
                                                            object_group_member_add(record, select_store, 'obj_ip_v4_group', me);
                                                        }
                                                    },
                                                    flex: 1,
                                                    margin: '1 10 1 0',
                                                    ...
                                                    handler: function(button, e) {
                                                        ...
                                                        if(record)
                                                        {
                                                            ...
                                                            function(response){
                                                                ...
                                                                if(response._kind === "obj_ip_v4_addr")
                                                                {
                                                                    object_window = Ext.create('SMC.view.pnl_object_ipv4_addr');
                                                                }
                                                                else if(response._kind === "obj_ip_v4_group")
                                                                {
                            ...
                            items: [
                                {
                                    xtype: 'button',
                                    handler: function(button, e) {
                                        button.up('window[itemId="pnl_object_ipv4_addr_group"]').saveData();
                                    },
                                    itemId: 'btn_save',
                                    margin: '1 20 1 0',
                                    width: 100,
                                ...
                                },
                                {
                                    xtype: 'button',
                                    handler: function(button, e) {
                                        button.up('window[itemId="pnl_object_ipv4_addr_group"]').destroy();
                                    },
                                    margin: 1,
                                    width: 100,
                                    text: '취소'
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_object_ipv4_addr_groupAfterRender,
                    scope: me
                },
                beforedestroy: {
                    fn: me.onPnl_object_ipv4_addr_groupBeforeDestroy,
                    scope: me
                }
            }
        });
    ...
    onToolbarAfterRender: function(component, eOpts) {
        ...
        var treeObj = component.up('[itemId=pnl_ipv4_group]').down('[itemId=trpn_object_tree]');
            ...
            if(treeSelection.raw._kind)
            {
                ...
                fn : function(res){
                     ...
                     if(res === 'yes'){
                         ...
                         if(treeSelection.raw.cid === component.up('window[itemId="pnl_object_ipv4_addr_group"]').object['@groupcid']){
        ...
        recursiveBtn.on('click', function(button){
            ...
            if(treeSelection)
            {
                component.up('[itemId=pnl_ipv4_group]').down('[itemId=gpn_object_grid]').gridRefresh('treeSelect', treeSelection);
            }
        });
        ...
        refreshBtn.on('click', function(){
            ...
            component.up('container[itemId="ctn_ipv4_group"]').setLoading(true);
            ...
            request_helper.xmlrpc_call_Ajax_Post(
                ...
                function(response){
                    ...
                    component.up('container[itemId="ctn_ipv4_group"]').setLoading(false);

                    for(var i=0; i<response.children.length; i++)
                    {
                        if(response.children[i].gtype === 'obj_ip_v4_group')
                        {
                            component.up('[itemId=pnl_object_ipv4_addr_group]')['@groupcid'] = response.children[i].cid;
                        }
    ...
    onToolbarAfterRender1: function(component, eOpts) {
        var me_objectList = component.up('window[itemId=pnl_object_ipv4_addr_group]');
    ...
    onTxf_ObjectSearchTextKeypress1: function(textfield, e, eOpts) {
        // 2015.06.08 김민수 - 검색 함수 재정의 ================================================================================================================================================================================
        //
        // 일 시 : 2015.06.08
        //
    ...
    onGpn_ipv4_gridItemDblClick: function(dataview, record, item, index, e, eOpts) {
        if(record)
        {
            ...
            object_group_member_add(record, this.down('gridpanel[itemId="gpn_object_select_grid"]').getStore(), 'obj_ip_v4_group', this);
        }
    },
    ...
    onPnl_object_ipv4_addr_groupAfterRender: function(component, eOpts) {
    ...
    onPnl_object_ipv4_addr_groupBeforeDestroy: function(component, eOpts) {
        if(!component.isNew)
        {
            var _svc = 'ftSMC',
                _func = 'clrObject',
    ...
    addObject: function() {
        ...
        if(record)
        {
            if(record.raw._kind === "obj_ip_v4_addr")
            {
                object_window = Ext.create('SMC.view.pnl_object_ipv4_addr');
            }
            else if(record.raw._kind === "obj_ip_v4_group")
            {
                object_window = Ext.create('SMC.view.pnl_object_ipv4_addr_group');
