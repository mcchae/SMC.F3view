...
Ext.define('SMC.view.pnl_object_ipv6_addr_group', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            set_obj_tree: function(new_group) {
                                                ...
                                                treeObj.up('container[itemId="ctn_ipv6_group"]').setLoading(true);
                                                ...
                                                function(response){
                                                    ...
                                                    treeObj.up('container[itemId="ctn_ipv6_group"]').setLoading(false);

                                                    for(var i=0; i<response.children.length; i++)
                                                    {
                                                        if(response.children[i].gtype === 'obj_ip_v6_group')
                                                        {
                                                            treeObj.up('window[itemId="pnl_object_ipv6_addr_group"]')['@groupcid'] = response.children[i].cid;
                                                        }
                                                    ...
                                                    if(new_group)
                                                    {
                                                        treeObj.getSelectionModel().store.each(function(data, idx){
                                                            ...
                                                            {
                                                                treeObj.up('window[itemId="pnl_object_ipv6_addr_group"]').down('gridpanel[itemId=gpn_object_grid]').searchChildGroup(new_group.cid, data.childNodes);
                                                                return false;
                                                            }
                                                            else if(new_group._kind.indexOf(data.raw.gtype) > -1)
                                                            {
                                                                if(data.childNodes.length > 0)
                                                                {
                                                                    for(var i=0; i<data.childNodes.length; i++)
                                                                    {
                                                                        ...
                                                                        {
                                                                            treeObj.up('window[itemId="pnl_object_ipv6_addr_group"]').down('gridpanel[itemId=gpn_object_grid]').searchChildGroup(new_group.cid, data.childNodes[i].childNodes);
                                                                            return false;
                                                                        }
                                                                    }
                                                                }
                                    ...
                                    items: [
                                            ...
                                            findObjectList: function(treeSel, chkCond, searchKey, searchValue) {
                                                ...
                                                if(searchValue){
                                                    ...
                                                    if(treeSel){
                                                        ...
                                                        condition.kind = ['obj_ip_v6_addr', 'obj_ip_v6_group'];
                                                    }
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, e) {
                                                        var treeSel = this.up('window[itemId=pnl_object_ipv6_addr_group]').down('treepanel[itemId="trpn_object_tree"]').getSelectionModel().getSelection()[0];
                                        ...
                                        },
                                        {
                                            ...
                                            gridRefresh: function(type, data, option) {
                                                ...
                                                var me = _grid.up('window[itemId=pnl_object_ipv6_addr_group]');
                                            ...
                                            searchChildGroup: function(cid, childNodes) {
                                                var treeObj = this.up('window[itemId=pnl_object_ipv6_addr_group]').down('treepanel[itemId="trpn_object_tree"]');
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_object_ipv6_addr_groupAfterRender,
                    scope: me
                },
                beforedestroy: {
                    fn: me.onPnl_object_ipv6_addr_groupBeforeDestroy,
                    scope: me
                }
            }
        });
    ...
    onToolbarAfterRender: function(component, eOpts) {
        ...
        var treeObj = component.up('[itemId=pnl_ipv6_group]').down('[itemId=trpn_object_tree]');
            ...
            if(treeSelection.raw._kind)
            {
                ...
                fn : function(res){
                     ...
                     if(res === 'yes'){
                         ...
                         if(treeSelection.raw.cid === component.up('window[itemId="pnl_object_ipv6_addr_group"]').object['@groupcid']){
        ...
        recursiveBtn.on('click', function(button){
            ...
            if(treeSelection)
            {
                component.up('[itemId=pnl_ipv6_group]').down('[itemId=gpn_object_grid]').gridRefresh('treeSelect', treeSelection);
            }
        });
        ...
        refreshBtn.on('click', function(){
            ...
            component.up('container[itemId="ctn_ipv6_group"]').setLoading(true);
            ...
            request_helper.xmlrpc_call_Ajax_Post(
                ...
                function(response){
                    ...
                    component.up('container[itemId="ctn_ipv6_group"]').setLoading(false);

                    for(var i=0; i<response.children.length; i++)
                    {
                        if(response.children[i].gtype === 'obj_ip_v6_group')
                        {
                            component.up('[itemId=pnl_object_ipv6_addr_group]')['@groupcid'] = response.children[i].cid;
                        }
    ...
    onToolbarAfterRender1: function(component, eOpts) {
        var me_objectList = component.up('window[itemId=pnl_object_ipv6_addr_group]');
