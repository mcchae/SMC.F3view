...
Ext.define('SMC.view.pnl_policy_Object_conf', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                {
                    ...
                    listeners: {
                        select: {
                            fn: me.onTrpn_object_viewSelect,
                            scope: me
                        }
                    }
                },
                {
                    ...
                    listeners: {
                        afterrender: {
                            fn: me.onPnl_object_listAfterRender,
                            scope: me
                        }
                    }
                }
            ...
            listeners: {
                afterrender: {
                    fn: me.onID_pnl_policy_Object_confAfterRender,
                    scope: me
                },
                removed: {
                    fn: me.onID_pnl_policy_Object_confRemoved,
                    scope: me
                }
            }
        });
