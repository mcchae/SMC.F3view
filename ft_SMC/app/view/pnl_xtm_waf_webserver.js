...
Ext.define('SMC.view.pnl_xtm_waf_webserver', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_waf_webserver',
        ...
        Ext.applyIf(me, {
            items: [
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                afterrender: {
                                    fn: me.onCtn_waf_controlAfterRender,
                                    scope: me
                                }
                            }
                        },
                        {
                            ...
                            listeners: {
                                render: {
                                    fn: me.onGpn_waf_waflistRender,
                                    scope: me
                                },
                                select: {
                                    fn: me.onGpn_waf_waflistSelect,
                                    scope: me
                                },
                                deselect: {
                                    fn: me.onGpn_waf_waflistDeselect,
                                    scope: me
                                }
                            }
                        }
                ...
                },
                {
                    ...
                    listeners: {
                        afterrender: {
                            fn: me.onTpn_waf_settingAfterRender,
                            scope: me
                        }
                    }
                }
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_waf_webserverAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_waf_webserverBeforeClose,
                    scope: me
                }
            }
        });
    ...
    onCtn_waf_controlAfterRender: function(component, eOpts) {
        ...
        bt_add.on('click', function(){
            ...
            Ext.create('widget.win_xtm_waf_addserver', {
