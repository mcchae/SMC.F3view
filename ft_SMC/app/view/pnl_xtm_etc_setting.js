...
Ext.define('SMC.view.pnl_xtm_etc_setting', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_etc_setting',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                change: {
                                    fn: me.onCmb_lineChange,
                                    scope: me
                                },
                                render: {
                                    fn: me.onCmb_lineRender,
                                    scope: me
                                }
                            }
                        },
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                        afterrender: {
                                            fn: me.onCtn_explicit_controlAfterRender,
                                            scope: me
                                        }
                                    }
                                },
                                {
                                    ...
                                    listeners: {
                                        render: {
                                            fn: me.onGpn_etc_explicitRender,
                                            scope: me
                                        },
                                        itemclick: {
                                            fn: me.onGpn_etc_explicitItemClick,
                                            scope: me
                                        }
                                    },
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            listeners: {
                                                render: {
                                                    fn: me.onCmb_selectfuncRender,
                                                    scope: me
                                                },
                                                change: {
                                                    fn: me.onCmb_selectfuncChange,
                                                    scope: me
                                                }
                                            }
                                        },
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                        afterrender: {
                                            fn: me.onCtn_bandwidth_controlAfterRender,
                                            scope: me
                                        }
                                    }
                                },
                                {
                                    ...
                                    listeners: {
                                        render: {
                                            fn: me.onGpn_etc_bandwidthlistRender,
                                            scope: me
                                        },
                                        itemclick: {
                                            fn: me.onGpn_etc_bandwidthlistItemClick,
                                            scope: me
                                        }
                                    },
                                    selModel: Ext.create('Ext.selection.RowModel', {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_etc_settingAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_etc_settingBeforeClose,
                    scope: me
                }
            }
        });
    ...
    onCmb_lineRender: function(component, eOpts) {
        // onCmb_lineRender ==============================================================================================================================================================
        //
        // 일시 : 2014.10.10
        //
    ...
    onCmb_selectfuncRender: function(component, eOpts) {
    ...
    onCtn_bandwidth_controlAfterRender: function(component, eOpts) {
        ...
        bt_add.on('click', function(){
            ...
            var dat_bandtype = componentObj.bandwidthact.getValue();
            var dat_bandtime = componentObj.bandwidthtime.getValue();

            // 필수항목검사 체크

            if(!me.validityCheck().blankCheck(componentObj.bandwidtheth) || !me.validityCheck().blankCheck(componentObj.bandwidthlimit)){
            ...
            if(dat_bandtype === 2){
                ...
                if(!me.validityCheck().blankCheck(componentObj.bandwidthtime)){
            ...
            if(!me.validityCheck().scaleValidate(componentObj.bandwidthlimit, '대역폭의 범위는 100~1000000 입니다.')){
            ...
            if(dat_bandtype === 2){
                ...
                if(!me.validityCheck().scaleValidate(componentObj.bandwidthtime, '유지시간의 범위는 1~1440 입니다.')){
            ...
            if(!me.validityCheck().duplicateCheck('add', componentObj.bandwidtheth.getValue(), null, '@name', 'st_etc_bandwidth', '인터페이스가 중복되었습니다.')){
        ...
        bt_mod.on('click', function(){
            ...
            if(!me.validityCheck().duplicateCheck('mod', componentObj.bandwidtheth.getValue(), componentObj.gpn_bandwidth.getSelectionModel().getSelection()[0].data['@name'], '@name', 'st_etc_bandwidth', '인터페이스가 중복되었습니다.')){
    ...
    onCmb_actmodeRender: function(component, eOpts) {
        // onCmb_actmodeRender ==========================================================================================================================================================
        //
        // 일시 : 2014.10.10
        //
