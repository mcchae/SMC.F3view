...
Ext.define('SMC.view.pnl_xtm_anomaly_traffic', {
    ...
    onNfd_dispersionBlur: function(component, e, eOpts) {
    ...
    onNfd_dispersionBlur1: function(component, e, eOpts) {
        if(component.getValue() === null){
    ...
    onNfd_dispersionBlur2: function(component, e, eOpts) {
        if(component.getValue() === null){
    ...
    onPnl_xtm_anomaly_trafficAfterRender: function(component, eOpts) {
        ...
        // DDOS 필드셋 Change 이벤트 연결 ==================================================================================================================================================

        componentObj.fds_ddos.checkboxCmp.on('change', function(component, newValue, oldValue, eOpts){

            if(newValue){

                componentObj.ddos_syn_dispersion.setValue(deviceData.ddos.syn['#text'] === undefined ? 1000 : deviceData.ddos.syn['#text']);
                componentObj.ddos_udp_dispersion.setValue(deviceData.ddos.udp['#text'] === undefined ? 1000 : deviceData.ddos.udp['#text']);
                componentObj.ddos_icmp_dispersion.setValue(deviceData.ddos.icmp['#text'] === undefined ? 1000 : deviceData.ddos.icmp['#text']);
        ...
        // DDOS Blank 체크 ===============================================================================================================================================================
            ...
            ddosValidCheck : function(){
                ...
                if(component.fds_ddos.checkboxCmp.getValue()){
                    ...
                    if(component.ddos_action.getValue() === 'drop' && !component.ddos_time.validate()){
