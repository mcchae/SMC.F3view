...
Ext.define('SMC.view.pnl_policy_rule_adv', {
                    ...
                    items: [
                        {
                            xtype: 'combobox',
                            margins: '5',
                            itemId: 'cb_policy_rule_adv_sessionlimit',
                            width: 350,
                            fieldLabel: '세션제한',
                            labelSeparator: ' ',
                            editable: false,
                            displayField: 'sessionName',
                            valueField: 'sessionCid',
                            listeners: {
                                change: {
                                    fn: me.onCb_policy_rule_adv_sessionlimit,
                                    scope: me
                                }
                            }
                        },
                            ...
                            items: [
                                {
                                    ...
                                    handler: function(button, e) {
                                        ...
                                        me.query('combobox[itemId="cb_policy_rule_adv_sessionlimit"]')[0].setValue('Any');
                                    },
                                    margin: '0 10 0 10',
                                    width: 24,
                                    iconCls: 'ico_grid_row_delete',
    ...
    onCb_policy_rule_adv_sessionlimit: function(field, newValue, oldValue, eOpts) {
        var me = this;
        me.fn_combo_change(field.getStore(), newValue, 'sessionName','sessionCid', 'session');
    },
    ...
    fn_view_init: function(_raw) {
        ...
        //sessionlimit
        var _sessioncb = me.query('combobox[itemId=cb_policy_rule_adv_sessionlimit]')[0];
        request_helper.xmlrpc_call_Ajax_Post(
            _svc,
            'getGroup',
            {gtype : Ext.encode('obj_session_limit')},
            function(response){
                console.log('session : ', response);
                bindList(response, 'sessionCid', 'sessionName', _sessioncb, [], 'session', true);
                console.log('session : ', _sessioncb);
            }
        );
