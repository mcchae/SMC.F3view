...
Ext.define('SMC.view.pnl_xtm_vpn_branch_office', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_vpn_branch_office',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                itemclick: {
                                    fn: me.onGpn_vpnbranch_sourceipItemClick,
                                    scope: me
                                }
                            },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                afterrender: {
                                    fn: me.onCtn_bridge_controlAfterRender1,
                                    scope: me
                                }
                            }
                        },
                        {
                            ...
                            listeners: {
                                itemclick: {
                                    fn: me.onGpn_vpnbranch_destipItemClick,
                                    scope: me
                                }
                            },
                            selModel: Ext.create('Ext.selection.RowModel', {
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_vpn_branch_officeAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_vpn_branch_officeBeforeClose,
                    scope: me
                }
            }
        });
    ...
    showGroupDrSetting: function(groupData) {
        ...
        Ext.create('SMC.view.win_xtm_vpn_branch_office', {
