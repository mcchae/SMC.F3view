...
Ext.define('SMC.view.pnl_xtm_network_dhcp_relay', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xtm_network_dhcp_relay',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                change: {
                                    fn: me.onCmb_dhcprelay_ethCange,
                                    scope: me
                                }
                            }
                        },
            ...
            listeners: {
                afterrender: {
                    fn: me.onPnl_xtm_network_dhcp_relayAfterRender,
                    scope: me
                },
                beforeclose: {
                    fn: me.onPnl_xtm_network_dhcp_relayBeforeClose,
                    scope: me
                }
            }
        });
    ...
    onCmb_dhcprelay_ethCange: function(field, newValue, oldValue, eOpts) {
        ...
        // DHCP Relay Validate 추가 20150916
        if(!Ext.getCmp('pnl_xtm_network_dhcp_relay').validityCheck().dhcpAddrCheck()){
