...
Ext.define('SMC.view.pnl_main_top', {
    ...
    onBtn_SMC_main_DeviceClick: function(button, e, eOpts) {
        ...
        var rdg_chkmode = pnl_center.down('[itemId=tb_smc_device_search]').down('[itemId=rdg_smc_selelctmode]');

        // 장비 타이머 객체 초기화

        if(pnl_center.taskObj){
        ...
        if(rdg_chkmode.getValue().mode === 'device'){
            ...
            var pnl_rtmcenter = Ext.getCmp('pnl_rtm_main');

            pnl_rtmcenter.timer_tick();
    ...
    onBtn_SMC_main_policiesClick: function(button, e, eOpts) {
        ...
        if(Ext.getCmp('pnl_smc_device_center').taskObj){

            clearInterval(Ext.getCmp('pnl_smc_device_center').taskObj);

        }

        Ext.getCmp('cont_SMC_main_center').getLayout().setActiveItem(1);
    ...
    onBtn_SMC_main_ObjectsClick: function(button, e, eOpts) {
        ...
        Ext.getCmp('cont_SMC_main_center').getLayout().setActiveItem(2);
    ...
    onBtn_SMC_main_ConfigClick: function(button, e, eOpts) {
        ...
        Ext.getCmp('cont_SMC_main_center').getLayout().setActiveItem(3);
    ...
    button_toggle: function(button) {
        ...
        request_helper.xmlrpc_call_JsonP(
            ...
            'session_ping',
            {
                ...
                'sid' : Ext.encode(vp.clientInfo.sessionInfo)
